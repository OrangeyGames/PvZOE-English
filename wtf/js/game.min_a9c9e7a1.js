        ...
        return __extends(r, e), Object.defineProperty(r.prototype, "bounces", {
            ...
            if (void 0 === r && (r = !1), (!r || 0 != t || 0 != e) && (r || this._ScrV_Props_._scrollTop != t || this._ScrV_Props_._scrollLeft != e)) {
                ...
                if (r) {
                    ...
                    c || ((0 >= a || a >= s) && (a = Math.max(0, Math.min(a, s))), (0 >= h || h >= n) && (h = Math.max(0, Math.min(h, n)))), this._ScrV_Props_._scrollTop = a, this._ScrV_Props_._scrollLeft = h
            ...
            var i = Math.abs(t),
                ...
                h = e + 500 * t;
            if (0 > h || h > r)
                for (h = e; Math.abs(t) != 1 / 0 && Math.abs(t) > a;) h += t, t *= 0 > h || h > r ? s * o : s, n++;
    ...
    var r = function(r) {
        ...
        return __extends(i, r), i.prototype.load = function(r) {
            ...
            var r = e._request.url,
                i = new t.Sound;
            this.sound = i, i.addEventListener(t.Event.COMPLETE, this.onSoundoadComplete, this), i.addEventListener(t.IOErrorEvent.IO_ERROR, this.onSoundLoaderError, this), i.addEventListener(t.ProgressEvent.PROGRESS, this.onSoundLoaderPostProgress, this), i.load(r)
            ...
            this.imageLoader = r, r.addEventListener(t.Event.COMPLETE, this.onImageLoadComplete, this), r.addEventListener(t.IOErrorEvent.IO_ERROR, this.onImageLoaderError, this), r.addEventListener(t.ProgressEvent.PROGRESS, this.onImageLoaderPostProgress, this), r.load(this.virtualUrl)
        }, i.prototype.onImageLoadComplete = function(e) {
            var r = this;
            this.removeImageLoaderListeners();
            var i = new t.Texture,
                o = this.imageLoader.data;
            o.source.setAttribute && o.source.setAttribute("bitmapSrc", this.virtualUrl), i._setBitmapData(o), this.data = i, window.setTimeout(function() {
                r.dispatchEventWith(t.Event.COMPLETE)
            }, 0)
