...
! function(t) {
    ...
    t.IntSet = e, __reflect(e.prototype, "spine.IntSet");
    var n = function() {
        function t(t, e, n, r) {
    ...
    t.Color = n, __reflect(n.prototype, "spine.Color");
    var r = function() {
        function t() {}
        return t.clamp = function(t, e, n) {
            ...
            var r = Math.random(),
                a = e - t;
            return (n - t) / a >= r ? t + Math.sqrt(r * a * (n - t)) : e - Math.sqrt((1 - r) * a * (e - n))
    ...
    t.MathUtils = r, __reflect(r.prototype, "spine.MathUtils");
    var a = function() {
        function t() {}
    ...
    t.Interpolation = a, __reflect(a.prototype, "spine.Interpolation");
    var i = function(t) {
        function e(e) {
    ...
    t.Pow = i, __reflect(i.prototype, "spine.Pow");
    var o = function(t) {
        function e(e) {
    ...
    t.PowOut = o, __reflect(o.prototype, "spine.PowOut");
    var s = function() {
        function t() {}
        return t.arrayCopy = function(t, e, n, r, a) {
            for (var i = e, o = r; e + a > i; i++, o++) n[o] = t[i]
        }, t.setArraySize = function(t, e, n) {
            void 0 === n && (n = 0);
            var r = t.length;
            if (r == e) return t;
            if (t.length = e, e > r)
                for (var a = r; e > a; a++) t[a] = n;
            return t
    ...
    t.Utils = s, __reflect(s.prototype, "spine.Utils");
    var l = function() {
        function t() {}
    ...
    t.DebugUtils = l, __reflect(l.prototype, "spine.DebugUtils");
    var h = function() {
        function t(t) {
    ...
    t.Pool = h, __reflect(h.prototype, "spine.Pool");
    var u = function() {
        function t(t, e) {
    ...
    t.TimeKeeper = c, __reflect(c.prototype, "spine.TimeKeeper");
    var p = function() {
        function t(t) {
    ...
    t.WindowedMean = p, __reflect(p.prototype, "spine.WindowedMean")
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
    ...
    var e = function() {
        ...
        return e.prototype.triangulate = function(t) {
            var n = t,
                ...
                a = this.indicesArray;
            a.length = 0;
            for (var i = 0; r > i; i++) a[i] = i;
            var o = this.isConcaveArray;
            o.length = 0;
            for (var i = 0, s = r; s > i; ++i) o[i] = e.isConcave(i, r, n, a);
            var l = this.triangles;
            for (l.length = 0; r > 3;) {
                for (var h = r - 1, i = 0, u = 1;;) {
                    t: if (!o[i]) {
                        for (var c = a[h] << 1, p = a[i] << 1, d = a[u] << 1, f = n[c], m = n[c + 1], v = n[p], g = n[p + 1], y = n[d], w = n[d + 1], x = (u + 1) % r; x != h; x = (x + 1) % r)
                            if (o[x]) {
                                var E = a[x] << 1,
                                    M = n[E],
                                    T = n[E + 1];
                                if (e.positiveArea(y, w, f, m, M, T) && e.positiveArea(f, m, v, g, M, T) && e.positiveArea(v, g, y, w, M, T)) break t
                            }
                        break
                    }if (0 == u) {
                        do {
                ...
                l.push(a[(r + i - 1) % r]), l.push(a[i]), l.push(a[(i + 1) % r]), a.splice(i, 1), o.splice(i, 1), r--;
                var A = (r + i - 1) % r,
                    S = i == r ? 0 : i;
                o[A] = e.isConcave(A, r, n, a), o[S] = e.isConcave(S, r, n, a)
            }
            ...
            s.length = 0;
            for (var l = -1, h = 0, u = 0, c = n.length; c > u; u += 3) {
                var p = n[u] << 1,
                    d = n[u + 1] << 1,
                    f = n[u + 2] << 1,
                    m = r[p],
                ...
                if (l == p) {
                    var M = s.length - 4,
                        T = e.winding(s[M], s[M + 1], s[M + 2], s[M + 3], w, x),
                        A = e.winding(w, x, s[0], s[1], s[2], s[3]);
                    T == h && A == h && (s.push(w), s.push(x), o.push(f), E = !0)
                }
                E || (s.length > 0 ? (a.push(s), i.push(o)) : (this.polygonPool.free(s), this.polygonIndicesPool.free(o)), s = this.polygonPool.obtain(), s.length = 0, s.push(m), s.push(v), s.push(g), s.push(y), s.push(w), s.push(x), o = this.polygonIndicesPool.obtain(), o.length = 0, o.push(p), o.push(d), o.push(f), h = e.winding(m, v, g, y, w, x), l = p)
            }
            ...
            for (var u = 0, c = a.length; c > u; u++)
                if (o = i[u], 0 != o.length) {
                    var S = o[0],
                        b = o[o.length - 1];
                    s = a[u];
                    for (var M = s.length - 4, R = s[M], I = s[M + 1], C = s[M + 2], _ = s[M + 3], P = s[0], k = s[1], V = s[2], F = s[3], N = e.winding(R, I, C, _, P, k), U = 0; c > U; U++)
                        if (U != u) {
                            var D = i[U];
                            if (3 == D.length) {
                                var L = D[0],
                                    ...
                                    x = B[B.length - 1];
                                if (L == S && Y == b) {
                                    var T = e.winding(R, I, C, _, w, x),
                                        A = e.winding(w, x, P, k, V, F);
                                    T == N && A == N && (B.length = 0, D.length = 0, s.push(w), s.push(x), o.push(X), R = C, I = _, C = w, _ = x, U = 0)
                                }
                            }
                        }
                }
            for (var u = a.length - 1; u >= 0; u--) s = a[u], 0 == s.length && (a.splice(u, 1), this.polygonPool.free(s), o = i[u], i.splice(u, 1), this.polygonIndicesPool.free(o));
            return a
...
! function(t) {
    var e = function() {
        ...
        return e.prototype.clipStart = function(n, r) {
            ...
            var a = r.worldVerticesLength,
                i = t.Utils.setArraySize(this.clippingPolygon, a);
            r.computeWorldVertices(n, 0, a, i, 0, 2);
            var o = this.clippingPolygon;
            e.makeClockwise(o);
            for (var s = this.clippingPolygons = this.triangulator.decompose(o, this.triangulator.triangulate(o)), l = 0, h = s.length; h > l; l++) {
                var u = s[l];
            ...
            t: for (var v = 0; a > v; v += 3) {
                ...
                var M = e[g],
                    ...
                    S = i[g + 1];
                g = r[v + 2] << 1;
                for (var b = e[g], R = e[g + 1], I = i[g], C = i[g + 1], _ = 0; d > _; _++) {
                    var P = u.length;
                    if (!this.clip(y, w, M, T, b, R, p[_], h)) {
                        var k = t.Utils.setArraySize(u, P + 3 * f);
                        k[P] = y, k[P + 1] = w, k[P + 2] = o.r, k[P + 3] = o.g, k[P + 4] = o.b, k[P + 5] = o.a, l ? (k[P + 6] = x, k[P + 7] = E, k[P + 8] = s.r, k[P + 9] = s.g, k[P + 10] = s.b, k[P + 11] = s.a, k[P + 12] = M, k[P + 13] = T, k[P + 14] = o.r, k[P + 15] = o.g, k[P + 16] = o.b, k[P + 17] = o.a, k[P + 18] = A, k[P + 19] = S, k[P + 20] = s.r, k[P + 21] = s.g, k[P + 22] = s.b, k[P + 23] = s.a, k[P + 24] = b, k[P + 25] = R, k[P + 26] = o.r, k[P + 27] = o.g, k[P + 28] = o.b, k[P + 29] = o.a, k[P + 30] = I, k[P + 31] = C, k[P + 32] = s.r, k[P + 33] = s.g, k[P + 34] = s.b, k[P + 35] = s.a) : (k[P + 6] = x, k[P + 7] = E, k[P + 8] = M, k[P + 9] = T, k[P + 10] = o.r, k[P + 11] = o.g, k[P + 12] = o.b, k[P + 13] = o.a, k[P + 14] = A, k[P + 15] = S, k[P + 16] = b, k[P + 17] = R, k[P + 18] = o.r, k[P + 19] = o.g, k[P + 20] = o.b, k[P + 21] = o.a, k[P + 22] = I, k[P + 23] = C), P = c.length;
                        var V = t.Utils.setArraySize(c, P + 3);
                        V[P] = m, V[P + 1] = m + 1, V[P + 2] = m + 2, m += 3;
                        continue t
                    }
                    var F = h.length;
                    if (0 != F) {
                        for (var N = T - R, U = b - M, D = y - b, L = R - w, Y = 1 / (N * D + U * (w - R)), X = F >> 1, B = this.clipOutput, k = t.Utils.setArraySize(u, P + X * f), O = 0; F > O; O += 2) {
                            var W = B[O],
                                q = B[O + 1];
                            k[P] = W, k[P + 1] = q, k[P + 2] = o.r, k[P + 3] = o.g, k[P + 4] = o.b, k[P + 5] = o.a;
                            var H = W - b,
                                G = q - R,
                                j = (N * H + U * G) * Y,
                                Z = (L * H + D * G) * Y,
                                z = 1 - j - Z;
                            k[P + 6] = x * j + A * Z + I * z, k[P + 7] = E * j + S * Z + C * z, l && (k[P + 8] = s.r, k[P + 9] = s.g, k[P + 10] = s.b, k[P + 11] = s.a), P += f
                        }
                        P = c.length;
                        var V = t.Utils.setArraySize(c, P + 3 * (X - 2));
                        X--;
                        for (var O = 1; X > O; O++) V[P] = m, V[P + 1] = m + O, V[P + 2] = m + O + 1, P += 3;
                        m += X + 1
                    }
                }
            }
            ...
            for (var c = o, p = o.length - 4, d = 0;; d += 2) {
                for (var f = c[d], m = c[d + 1], v = c[d + 2], g = c[d + 3], y = f - v, w = m - g, x = u, E = u.length - 2, M = s.length, T = 0; E > T; T += 2) {
                    var A = x[T],
                        S = x[T + 1],
                        b = x[T + 2],
                        R = x[T + 3],
                    ...
                    if (y * (S - g) - w * (A - v) > 0) {
                        ...
                        if (Math.abs(P) > 1e-6) {
                            var k = (_ * (m - S) - C * (f - A)) / P;
                            s.push(f + (v - f) * k), s.push(m + (g - m) * k)
                        } else s.push(f), s.push(m)
                    } else if (I) {
                        var C = R - S,
                            _ = b - A,
                            P = C * (v - f) - _ * (g - m);
                ...
                if (M == s.length) return l.length = 0, !0;
            ...
            if (l != s) {
                l.length = 0;
                for (var d = 0, F = s.length - 2; F > d; d++) l[d] = s[d]
            } else l.length = l.length - 2;
            return h
        }, e.makeClockwise = function(t) {
            for (var e = t, n = t.length, r = e[n - 2] * e[1] - e[0] * e[n - 1], a = 0, i = 0, o = 0, s = 0, l = 0, h = n - 3; h > l; l += 2) a = e[l], i = e[l + 1], o = e[l + 2], s = e[l + 3], r += a * s - o * i;
            if (!(0 > r))
                for (var l = 0, u = n - 2, h = n >> 1; h > l; l += 2) {
                    var c = e[l],
                        p = e[l + 1],
                        d = u - l;
                    e[l] = e[d], e[l + 1] = e[d + 1], e[d] = c, e[d + 1] = p
                }
        }, e
    }();
...
! function(t) {
    ...
    t.TextureRegion = a, __reflect(a.prototype, "spine.TextureRegion");
    var i = function(t) {
        function e() {
    ...
    t.FakeTexture = i, __reflect(i.prototype, "spine.FakeTexture")
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
        function e(e, r, a) {
            if (this.x = 0, this.y = 0, this.rotation = 0, this.scaleX = 1, this.scaleY = 1, this.shearX = 0, this.shearY = 0, this.transformMode = n.Normal, this.skinRequired = !1, this.color = new t.Color, 0 > e) throw new Error("index must be >= 0.");
            if (null == r) throw new Error("name cannot be null.");
            this.index = e, this.name = r, this.parent = a
        }
        return e
    }();
...
! function(t) {
    var e = function() {
        ...
        return t.prototype.hasTimeline = function(t) {
            ...
            for (var l = this.timelines, h = 0, u = l.length; u > h; h++) l[h].apply(t, e, n, a, i, o, s)
            ...
            for (var r = 0, a = t.length - n; a >= r; r += n)
                if (t[r] > e) return r;
            return -1
        }, t
    }();
    ...
    var i = function() {
        function e(n) {
            if (0 >= n) throw new Error("frameCount must be > 0: " + n);
        ...
        return e.prototype.getFrameCount = function() {
            ...
            var o = .03 * (2 * -n + a),
                ...
                m = this.curves;
            m[f++] = e.BEZIER;
            for (var v = p, g = d, y = f + e.BEZIER_SIZE - 1; y > f; f += 2) m[f] = v, m[f + 1] = g, p += u, d += c, u += l, c += h, v += p, g += d
            ...
            i++;
            for (var s = 0, l = i, h = i + e.BEZIER_SIZE - 1; h > i; i += 2)
                if (s = a[i], s >= r) {
                    var u = void 0,
                        c = void 0;
    ...
    t.CurveTimeline = i, __reflect(i.prototype, "spine.CurveTimeline", ["spine.Timeline"]);
    var o = function(r) {
        function i(e) {
            var n = r.call(this, e) || this;
            return n.frames = t.Utils.newFloatArray(e << 1), n
        }
        return __extends(i, r), i.prototype.getPropertyId = function() {
            return (a.rotate << 24) + this.boneIndex
        }, i.prototype.setFrame = function(t, e, n) {
            t <<= 1, this.frames[t] = e, this.frames[t + i.ROTATION] = n
        }, i.prototype.apply = function(t, r, a, o, s, l, h) {
            var u = this.frames,
            ...
            if (c.active)
                if (a < u[0]) switch (l) {
                ...
                } else if (a >= u[u.length - i.ENTRIES]) {
                    ...
                    var f = e.binarySearch(u, a, i.ENTRIES),
                        m = u[f + i.PREV_ROTATION],
                        v = u[f],
                        g = this.getCurvePercent((f >> 1) - 1, 1 - (a - v) / (u[f + i.PREV_TIME] - v)),
                        y = u[f + i.ROTATION] - m;
                    switch (y = m + (y - 360 * (16384 - (16384.499999999996 - y / 360 | 0))) * g, l) {
                        case n.setup:
    ...
    t.RotateTimeline = o, __reflect(o.prototype, "spine.RotateTimeline");
    var s = function(r) {
        function i(e) {
            var n = r.call(this, e) || this;
            return n.frames = t.Utils.newFloatArray(e * i.ENTRIES), n
        }
        return __extends(i, r), i.prototype.getPropertyId = function() {
            ...
            if (c.active)
                if (a < u[0]) switch (l) {
                    ...
                    var p = 0,
                        d = 0;
                    if (a >= u[u.length - i.ENTRIES]) p = u[u.length + i.PREV_X], d = u[u.length + i.PREV_Y];
                    else {
                        var f = e.binarySearch(u, a, i.ENTRIES);
                        p = u[f + i.PREV_X], d = u[f + i.PREV_Y];
                        var m = u[f],
                            v = this.getCurvePercent(f / i.ENTRIES - 1, 1 - (a - m) / (u[f + i.PREV_TIME] - m));
                        p += (u[f + i.X] - p) * v, d += (u[f + i.Y] - d) * v
                    }
                    switch (l) {
                        case n.setup:
    ...
    t.TranslateTimeline = s, __reflect(s.prototype, "spine.TranslateTimeline");
    var l = function(i) {
        function o(t) {
        ...
        }, o.prototype.apply = function(a, i, s, l, h, u, c) {
            var p = this.frames,
                d = a.bones[this.boneIndex];
            if (d.active)
                if (s < p[0]) switch (u) {
                    case n.setup:
                    ...
                    var f = 0,
                        m = 0;
                    if (s >= p[p.length - o.ENTRIES]) f = p[p.length + o.PREV_X] * d.data.scaleX, m = p[p.length + o.PREV_Y] * d.data.scaleY;
                    else {
                        var v = e.binarySearch(p, s, o.ENTRIES);
                        f = p[v + o.PREV_X], m = p[v + o.PREV_Y];
                        var g = p[v],
                            y = this.getCurvePercent(v / o.ENTRIES - 1, 1 - (s - g) / (p[v + o.PREV_TIME] - g));
                        f = (f + (p[v + o.X] - f) * y) * d.data.scaleX, m = (m + (p[v + o.Y] - m) * y) * d.data.scaleY
                    }
                    if (1 == h) u == n.add ? (d.scaleX += f - d.data.scaleX, d.scaleY += m - d.data.scaleY) : (d.scaleX = f, d.scaleY = m);
                    else {
                        var w = 0,
                            x = 0;
                        if (c == r.mixOut) switch (u) {
                            case n.setup:
                                w = d.data.scaleX, x = d.data.scaleY, d.scaleX = w + (Math.abs(f) * t.MathUtils.signum(w) - w) * h, d.scaleY = x + (Math.abs(m) * t.MathUtils.signum(x) - x) * h;
                                break;
                            case n.first:
                            case n.replace:
                                w = d.scaleX, x = d.scaleY, d.scaleX = w + (Math.abs(f) * t.MathUtils.signum(w) - w) * h, d.scaleY = x + (Math.abs(m) * t.MathUtils.signum(x) - x) * h;
                                break;
                            case n.add:
                                w = d.scaleX, x = d.scaleY, d.scaleX = w + (Math.abs(f) * t.MathUtils.signum(w) - d.data.scaleX) * h, d.scaleY = x + (Math.abs(m) * t.MathUtils.signum(x) - d.data.scaleY) * h
                        } else switch (u) {
                            case n.setup:
                                w = Math.abs(d.data.scaleX) * t.MathUtils.signum(f), x = Math.abs(d.data.scaleY) * t.MathUtils.signum(m), d.scaleX = w + (f - w) * h, d.scaleY = x + (m - x) * h;
                                break;
                            case n.first:
                            case n.replace:
                                w = Math.abs(d.scaleX) * t.MathUtils.signum(f), x = Math.abs(d.scaleY) * t.MathUtils.signum(m), d.scaleX = w + (f - w) * h, d.scaleY = x + (m - x) * h;
                                break;
                            case n.add:
                                w = t.MathUtils.signum(f), x = t.MathUtils.signum(m), d.scaleX = Math.abs(d.scaleX) * w + (f - Math.abs(d.data.scaleX) * w) * h, d.scaleY = Math.abs(d.scaleY) * x + (m - Math.abs(d.data.scaleY) * x) * h
                        }
                    }
                }
        }, o
    }(s);
    t.ScaleTimeline = l, __reflect(l.prototype, "spine.ScaleTimeline");
    var h = function(t) {
        function r(e) {
            return t.call(this, e) || this
        }
        ...
        }, r.prototype.apply = function(t, a, i, o, s, l, h) {
            var u = this.frames,
                c = t.bones[this.boneIndex];
            if (c.active)
                if (i < u[0]) switch (l) {
                    ...
                    var p = 0,
                        d = 0;
                    if (i >= u[u.length - r.ENTRIES]) p = u[u.length + r.PREV_X], d = u[u.length + r.PREV_Y];
                    else {
                        var f = e.binarySearch(u, i, r.ENTRIES);
                        p = u[f + r.PREV_X], d = u[f + r.PREV_Y];
                        var m = u[f],
                            v = this.getCurvePercent(f / r.ENTRIES - 1, 1 - (i - m) / (u[f + r.PREV_TIME] - m));
                        p += (u[f + r.X] - p) * v, d += (u[f + r.Y] - d) * v
                    }
                    switch (l) {
                        case n.setup:
    ...
    t.ShearTimeline = h, __reflect(h.prototype, "spine.ShearTimeline");
    var u = function(r) {
        function i(e) {
            var n = r.call(this, e) || this;
            return n.frames = t.Utils.newFloatArray(e * i.ENTRIES), n
            ...
            if (u.bone.active) {
                ...
                if (a < c[0]) switch (l) {
                    ...
                    var f = 0,
                        ...
                        v = 0,
                        g = 0;
                    if (a >= c[c.length - i.ENTRIES]) {
                        var y = c.length;
                        f = c[y + i.PREV_R], m = c[y + i.PREV_G], v = c[y + i.PREV_B], g = c[y + i.PREV_A]
                    } else {
                        var w = e.binarySearch(c, a, i.ENTRIES);
                        f = c[w + i.PREV_R], m = c[w + i.PREV_G], v = c[w + i.PREV_B], g = c[w + i.PREV_A];
                        var x = c[w],
                            E = this.getCurvePercent(w / i.ENTRIES - 1, 1 - (a - x) / (c[w + i.PREV_TIME] - x));
                        f += (c[w + i.R] - f) * E, m += (c[w + i.G] - m) * E, v += (c[w + i.B] - v) * E, g += (c[w + i.A] - g) * E
                    }
                    if (1 == s) u.color.set(f, m, v, g);
                    else {
                        var p = u.color;
                        l == n.setup && p.setFromColor(u.data.color), p.add((f - p.r) * s, (m - p.g) * s, (v - p.b) * s, (g - p.a) * s)
                    }
                }
            }
        }, i.ENTRIES = 5, i.PREV_TIME = -5, i.PREV_R = -4, i.PREV_G = -3, i.PREV_B = -2, i.PREV_A = -1, i.R = 1, i.G = 2, i.B = 3, i.A = 4, i
    }(i);
    t.ColorTimeline = u, __reflect(u.prototype, "spine.ColorTimeline");
    var c = function(r) {
        function i(e) {
            var n = r.call(this, e) || this;
            return n.frames = t.Utils.newFloatArray(e * i.ENTRIES), n
        ...
        return __extends(i, r), i.prototype.getPropertyId = function() {
            ...
            if (u.bone.active) {
                ...
                if (a < c[0]) switch (l) {
                    ...
                    if (a >= c[c.length - i.ENTRIES]) {
                        var T = c.length;
                        v = c[T + i.PREV_R], g = c[T + i.PREV_G], y = c[T + i.PREV_B], w = c[T + i.PREV_A], x = c[T + i.PREV_R2], E = c[T + i.PREV_G2], M = c[T + i.PREV_B2]
                    } else {
                        var A = e.binarySearch(c, a, i.ENTRIES);
                        v = c[A + i.PREV_R], g = c[A + i.PREV_G], y = c[A + i.PREV_B], w = c[A + i.PREV_A], x = c[A + i.PREV_R2], E = c[A + i.PREV_G2], M = c[A + i.PREV_B2];
                        var S = c[A],
                            b = this.getCurvePercent(A / i.ENTRIES - 1, 1 - (a - S) / (c[A + i.PREV_TIME] - S));
                        v += (c[A + i.R] - v) * b, g += (c[A + i.G] - g) * b, y += (c[A + i.B] - y) * b, w += (c[A + i.A] - w) * b, x += (c[A + i.R2] - x) * b, E += (c[A + i.G2] - E) * b, M += (c[A + i.B2] - M) * b
                    }
                    if (1 == s) u.color.set(v, g, y, w), u.darkColor.set(x, E, M, 1);
                    else {
                        var p = u.color,
                            d = u.darkColor;
                        l == n.setup && (p.setFromColor(u.data.color), d.setFromColor(u.data.darkColor)), p.add((v - p.r) * s, (g - p.g) * s, (y - p.b) * s, (w - p.a) * s), d.add((x - d.r) * s, (E - d.g) * s, (M - d.b) * s, 0)
                    }
                }
            }
    ...
    t.TwoColorTimeline = c, __reflect(c.prototype, "spine.TwoColorTimeline");
    var p = function() {
        function i(e) {
        ...
        }, i.prototype.apply = function(t, a, i, o, s, l, h) {
            var u = t.slots[this.slotIndex];
            if (u.bone.active) {
                if (h == r.mixOut) return void(l == n.setup && this.setAttachment(t, u, u.data.attachmentName));
                var c = this.frames;
                if (i < c[0]) return void((l == n.setup || l == n.first) && this.setAttachment(t, u, u.data.attachmentName));
                var p = 0;
                p = i >= c[c.length - 1] ? c.length - 1 : e.binarySearch(c, i, 1) - 1;
                var d = this.attachmentNames[p];
                t.slots[this.slotIndex].setAttachment(null == d ? null : t.getAttachment(this.slotIndex, d))
            }
        }, i.prototype.setAttachment = function(t, e, n) {
            e.attachment = null == n ? null : t.getAttachment(this.slotIndex, n)
        }, i
    }();
    t.AttachmentTimeline = p, __reflect(p.prototype, "spine.AttachmentTimeline", ["spine.Timeline"]);
    var d = null,
        f = function(r) {
            function i(e) {
                var n = r.call(this, e) || this;
                        ...
                        if (i < m[0]) {
                            ...
                            switch (l) {
                                ...
                                case n.first:
                                    ...
                                    var g = t.Utils.setArraySize(p, f);
                                    if (null == v.bones)
                                        for (var y = v.vertices, w = 0; f > w; w++) g[w] += (y[w] - g[w]) * s;
                                    else {
                                        s = 1 - s;
                                        for (var w = 0; f > w; w++) g[w] *= s
                                    }
                            }
                        } else {
                            var x = t.Utils.setArraySize(p, f);
                            if (i >= m[m.length - 1]) {
                                var E = d[m.length - 1];
                                if (1 == s)
                                    if (l == n.add) {
                                        var v = c;
                                        if (null == v.bones)
                                            for (var y = v.vertices, M = 0; f > M; M++) x[M] += E[M] - y[M];
                                        else
                                            for (var T = 0; f > T; T++) x[T] += E[T]
                                    } else t.Utils.arrayCopy(E, 0, x, 0, f);
                                else switch (l) {
                                    case n.setup:
                                        var A = c;
                                        if (null == A.bones)
                                            for (var y = A.vertices, S = 0; f > S; S++) {
                                                var b = y[S];
                                                x[S] = b + (E[S] - b) * s
                                            } else
                                                for (var R = 0; f > R; R++) x[R] = E[R] * s;
                                        break;
                                    case n.first:
                                    case n.replace:
                                        for (var I = 0; f > I; I++) x[I] += (E[I] - x[I]) * s;
                                        break;
                                    case n.add:
                                        var v = c;
                                        if (null == v.bones)
                                            for (var y = v.vertices, C = 0; f > C; C++) x[C] += (E[C] - y[C]) * s;
                                        else
                                            for (var _ = 0; f > _; _++) x[_] += E[_] * s
                                }
                            } else {
                                var P = e.binarySearch(m, i),
                                    k = d[P - 1],
                                    V = d[P],
                                    F = m[P],
                                    N = this.getCurvePercent(P - 1, 1 - (i - F) / (m[P - 1] - F));
                                if (1 == s)
                                    if (l == n.add) {
                                        var v = c;
                                        if (null == v.bones)
                                        ...
                                        for (var Y = 0; f > Y; Y++) {
                                            ...
                                            case n.setup:
                                                var X = c;
                                                if (null == X.bones)
                                                    for (var y = X.vertices, B = 0; f > B; B++) {
                                                        var D = k[B],
                                                            b = y[B];
                                                        x[B] = b + (D + (V[B] - D) * N - b) * s
                                                    } else
                                            ...
                                            case n.add:
                                                var v = c;
                                                if (null == v.bones)
                                                    for (var y = v.vertices, q = 0; f > q; q++) {
                                                        var D = k[q];
                                                        x[q] += (D + (V[q] - D) * N - y[q]) * s
                                                    } else
                                                        for (var H = 0; f > H; H++) {
    ...
    t.DeformTimeline = f, __reflect(f.prototype, "spine.DeformTimeline");
    var m = function() {
        function n(e) {
        ...
        }, n.prototype.apply = function(t, n, r, a, i, o, s) {
            if (null != a) {
                var l = this.frames,
                    h = this.frames.length;
                if (n > r) this.apply(t, n, Number.MAX_VALUE, a, i, o, s), n = -1;
                ...
                if (!(r < l[0])) {
                    ...
                    for (; h > u && r >= l[u]; u++) a.push(this.events[u])
                }
            }
        }, n
    }();
    t.EventTimeline = m, __reflect(m.prototype, "spine.EventTimeline", ["spine.Timeline"]);
    var v = function() {
        function i(e) {
        ...
        }, i.prototype.apply = function(a, i, o, s, l, h, u) {
            var c = a.drawOrder,
                p = a.slots;
            if (u == r.mixOut) return void(h == n.setup && t.Utils.arrayCopy(a.slots, 0, a.drawOrder, 0, a.slots.length));
            var d = this.frames;
            if (o < d[0]) return void((h == n.setup || h == n.first) && t.Utils.arrayCopy(a.slots, 0, a.drawOrder, 0, a.slots.length));
            var f = 0;
            f = o >= d[d.length - 1] ? d.length - 1 : e.binarySearch(d, o) - 1;
            var m = this.drawOrders[f];
            if (null == m) t.Utils.arrayCopy(p, 0, c, 0, p.length);
            else
                for (var v = 0, g = m.length; g > v; v++) c[v] = p[m[v]]
        }, i
    }();
    t.DrawOrderTimeline = v, __reflect(v.prototype, "spine.DrawOrderTimeline", ["spine.Timeline"]);
    var g = function(i) {
        function o(e) {
        ...
        return __extends(o, i), o.prototype.getPropertyId = function() {
        ...
        }, o.prototype.apply = function(t, a, i, s, l, h, u) {
            var c = this.frames,
            ...
            if (p.active)
                if (i < c[0]) switch (h) {
                    ...
                    if (i >= c[c.length - o.ENTRIES]) return void(h == n.setup ? (p.mix = p.data.mix + (c[c.length + o.PREV_MIX] - p.data.mix) * l, p.softness = p.data.softness + (c[c.length + o.PREV_SOFTNESS] - p.data.softness) * l, u == r.mixOut ? (p.bendDirection = p.data.bendDirection, p.compress = p.data.compress, p.stretch = p.data.stretch) : (p.bendDirection = c[c.length + o.PREV_BEND_DIRECTION], p.compress = 0 != c[c.length + o.PREV_COMPRESS], p.stretch = 0 != c[c.length + o.PREV_STRETCH])) : (p.mix += (c[c.length + o.PREV_MIX] - p.mix) * l, p.softness += (c[c.length + o.PREV_SOFTNESS] - p.softness) * l, u == r.mixIn && (p.bendDirection = c[c.length + o.PREV_BEND_DIRECTION], p.compress = 0 != c[c.length + o.PREV_COMPRESS], p.stretch = 0 != c[c.length + o.PREV_STRETCH])));
                    var d = e.binarySearch(c, i, o.ENTRIES),
                        f = c[d + o.PREV_MIX],
                        m = c[d + o.PREV_SOFTNESS],
                        v = c[d],
                        g = this.getCurvePercent(d / o.ENTRIES - 1, 1 - (i - v) / (c[d + o.PREV_TIME] - v));
                    h == n.setup ? (p.mix = p.data.mix + (f + (c[d + o.MIX] - f) * g - p.data.mix) * l, p.softness = p.data.softness + (m + (c[d + o.SOFTNESS] - m) * g - p.data.softness) * l, u == r.mixOut ? (p.bendDirection = p.data.bendDirection, p.compress = p.data.compress, p.stretch = p.data.stretch) : (p.bendDirection = c[d + o.PREV_BEND_DIRECTION], p.compress = 0 != c[d + o.PREV_COMPRESS], p.stretch = 0 != c[d + o.PREV_STRETCH])) : (p.mix += (f + (c[d + o.MIX] - f) * g - p.mix) * l, p.softness += (m + (c[d + o.SOFTNESS] - m) * g - p.softness) * l, u == r.mixIn && (p.bendDirection = c[d + o.PREV_BEND_DIRECTION], p.compress = 0 != c[d + o.PREV_COMPRESS], p.stretch = 0 != c[d + o.PREV_STRETCH]))
                }
    ...
    t.IkConstraintTimeline = g, __reflect(g.prototype, "spine.IkConstraintTimeline");
    var y = function(r) {
        function i(e) {
            var n = r.call(this, e) || this;
            return n.frames = t.Utils.newFloatArray(e * i.ENTRIES), n
            ...
            if (c.active)
                if (a < u[0]) {
                    ...
                    if (a >= u[u.length - i.ENTRIES]) {
                        var g = u.length;
                        d = u[g + i.PREV_ROTATE], f = u[g + i.PREV_TRANSLATE], m = u[g + i.PREV_SCALE], v = u[g + i.PREV_SHEAR]
                    } else {
                        var y = e.binarySearch(u, a, i.ENTRIES);
                        d = u[y + i.PREV_ROTATE], f = u[y + i.PREV_TRANSLATE], m = u[y + i.PREV_SCALE], v = u[y + i.PREV_SHEAR];
                        var w = u[y],
                            x = this.getCurvePercent(y / i.ENTRIES - 1, 1 - (a - w) / (u[y + i.PREV_TIME] - w));
                        d += (u[y + i.ROTATE] - d) * x, f += (u[y + i.TRANSLATE] - f) * x, m += (u[y + i.SCALE] - m) * x, v += (u[y + i.SHEAR] - v) * x
                    }
                    if (l == n.setup) {
                        var p = c.data;
                        c.rotateMix = p.rotateMix + (d - p.rotateMix) * s, c.translateMix = p.translateMix + (f - p.translateMix) * s, c.scaleMix = p.scaleMix + (m - p.scaleMix) * s, c.shearMix = p.shearMix + (v - p.shearMix) * s
                    } else c.rotateMix += (d - c.rotateMix) * s, c.translateMix += (f - c.translateMix) * s, c.scaleMix += (m - c.scaleMix) * s, c.shearMix += (v - c.shearMix) * s
                }
    ...
    t.TransformConstraintTimeline = y, __reflect(y.prototype, "spine.TransformConstraintTimeline");
    var w = function(r) {
        function i(e) {
            var n = r.call(this, e) || this;
            return n.frames = t.Utils.newFloatArray(e * i.ENTRIES), n
        ...
        return __extends(i, r), i.prototype.getPropertyId = function() {
            ...
            if (c.active)
                if (a < u[0]) switch (l) {
                    ...
                    var p = 0;
                    if (a >= u[u.length - i.ENTRIES]) p = u[u.length + i.PREV_VALUE];
                    else {
                        var d = e.binarySearch(u, a, i.ENTRIES);
                        p = u[d + i.PREV_VALUE];
                        var f = u[d],
                            m = this.getCurvePercent(d / i.ENTRIES - 1, 1 - (a - f) / (u[d + i.PREV_TIME] - f));
                        p += (u[d + i.VALUE] - p) * m
                    }
    ...
    t.PathConstraintPositionTimeline = w, __reflect(w.prototype, "spine.PathConstraintPositionTimeline");
    var x = function(t) {
        function r(e) {
            return t.call(this, e) || this
        }
        return __extends(r, t), r.prototype.getPropertyId = function() {
            ...
            if (c.active)
                if (i < u[0]) switch (l) {
                    ...
                    var p = 0;
                    if (i >= u[u.length - r.ENTRIES]) p = u[u.length + r.PREV_VALUE];
                    else {
                        var d = e.binarySearch(u, i, r.ENTRIES);
                        p = u[d + r.PREV_VALUE];
                        var f = u[d],
                            m = this.getCurvePercent(d / r.ENTRIES - 1, 1 - (i - f) / (u[d + r.PREV_TIME] - f));
                        p += (u[d + r.VALUE] - p) * m
                    }
    ...
    t.PathConstraintSpacingTimeline = x, __reflect(x.prototype, "spine.PathConstraintSpacingTimeline");
    var E = function(r) {
        function i(e) {
            var n = r.call(this, e) || this;
            return n.frames = t.Utils.newFloatArray(e * i.ENTRIES), n
        ...
        return __extends(i, r), i.prototype.getPropertyId = function() {
            ...
            if (c.active)
                if (a < u[0]) switch (l) {
                    ...
                    var p = 0,
                        d = 0;
                    if (a >= u[u.length - i.ENTRIES]) p = u[u.length + i.PREV_ROTATE], d = u[u.length + i.PREV_TRANSLATE];
                    else {
                        var f = e.binarySearch(u, a, i.ENTRIES);
                        p = u[f + i.PREV_ROTATE], d = u[f + i.PREV_TRANSLATE];
                        var m = u[f],
                            v = this.getCurvePercent(f / i.ENTRIES - 1, 1 - (a - m) / (u[f + i.PREV_TIME] - m));
                        p += (u[f + i.ROTATE] - p) * v, d += (u[f + i.TRANSLATE] - d) * v
                    }
                    l == n.setup ? (c.rotateMix = c.data.rotateMix + (p - c.data.rotateMix) * s, c.translateMix = c.data.translateMix + (d - c.data.translateMix) * s) : (c.rotateMix += (p - c.rotateMix) * s, c.translateMix += (d - c.translateMix) * s)
                }
        }, i.ENTRIES = 3, i.PREV_TIME = -3, i.PREV_ROTATE = -2, i.PREV_TRANSLATE = -1, i.ROTATE = 1, i.TRANSLATE = 2, i
    }(i);
    t.PathConstraintMixTimeline = E, __reflect(E.prototype, "spine.PathConstraintMixTimeline")
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
    ...
    var n = function(e) {
        ...
        return __extends(n, e), n.prototype.computeWorldVertices = function(t, e, n, r, a, i) {
            n = a + (n >> 1) * i;
            var o = t.bone.skeleton,
                ...
                h = this.bones;
            if (null != h) {
                for (var u = 0, c = 0, p = 0; e > p; p += 2) {
                    var d = h[u];
                    u += d + 1, c += d
                }
                var f = o.bones;
                if (0 == s.length)
                    for (var m = a, v = 3 * c; n > m; m += i) {
                        var g = 0,
                            y = 0,
                            d = h[u++];
                        for (d += u; d > u; u++, v += 3) {
                            var w = f[h[u]],
                                ...
                                E = l[v + 1],
                                M = l[v + 2];
                            g += (x * w.a + E * w.b + w.worldX) * M, y += (x * w.c + E * w.d + w.worldY) * M
                        }
                        r[m] = g, r[m + 1] = y
                    } else
                        for (var T = s, m = a, v = 3 * c, A = c << 1; n > m; m += i) {
                            var g = 0,
                                y = 0,
                                d = h[u++];
                            for (d += u; d > u; u++, v += 3, A += 2) {
                                var w = f[h[u]],
                                    x = l[v] + T[A],
                                    E = l[v + 1] + T[A + 1],
                                    M = l[v + 2];
                ...
                s.length > 0 && (l = s);
                for (var w = t.bone, S = w.worldX, b = w.worldY, R = w.a, v = w.b, I = w.c, C = w.d, _ = e, m = a; n > m; _ += 2, m += i) {
                    var x = l[_],
                        E = l[_ + 1];
                    r[m] = x * R + E * v + S, r[m + 1] = x * I + E * C + b
                }
            }
    ...
    t.VertexAttachment = n, __reflect(n.prototype, "spine.VertexAttachment")
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
        ...
        return t.prototype.on = function(t, e, n) {
            ...
            if (a)
                if (e)
                    for (var i = 0; i < a.length; i++) {
                        var o = a[i];
                        e !== o.fn || r && !o.once || n && o.context !== n || a.splice(i--, 1)
                    } else this.events["delete"](t);
            return this
            ...
            if (r)
                for (var a = 0; a < r.length; a++) {
                    var i = r[a];
                    i.once && r.splice(a--, 1), i.fn.apply(i.context, e)
                }
            return this
        }, t
    }();
        ...
        return e.prototype.isActive = function() {
            ...
            switch (e.data.transformMode) {
                ...
                case t.TransformMode.NoRotationOrReflection:
                    var v = Math.abs(h * p - u * c) / (h * h + c * c),
                        g = h / e.skeleton.scaleX,
                        y = c / e.skeleton.scaleY;
                    u = -y * v * e.skeleton.scaleX, p = g * v * e.skeleton.scaleY, d += Math.atan2(y, g) * t.MathUtils.radDeg;
                default:
                    var w = n - l.worldX,
                        x = r - l.worldY,
                        E = h * p - u * c;
                    f = (w * p - x * u) / E - e.ax, m = (x * h - w * c) / E - e.ay
            }
            ...
            if (a || i) {
                ...
                var A = e.data.length * M,
                    S = Math.sqrt(f * f + m * m);
                if (a && A > S || i && S > A && A > 1e-4) {
                    var v = (S / A - 1) * s + 1;
                    M *= v, o && (T *= v)
                }
            }
            e.updateWorldTransformWith(e.ax, e.ay, e.arotation + d * s, M, T, e.ashearX, e.ashearY)
        }, e.prototype.apply2 = function(e, n, r, a, i, o, s, l) {
            if (0 == l) return void n.updateWorldTransform();
            ...
            var h = e.ax,
                ...
                v = 0,
                g = 0;
            0 > c ? (c = -c, m = 180, g = -1) : (m = 0, g = 1), 0 > d && (d = -d, g = -g), 0 > f ? (f = -f, v = 180) : v = 0;
            var y = n.ax,
                w = 0,
                x = 0,
                E = 0,
                ...
                S = e.d,
                b = Math.abs(c - d) <= 1e-4;
            b ? (w = n.ay, x = M * y + T * w + e.worldX, E = A * y + S * w + e.worldY) : (w = 0, x = M * y + e.worldX, E = A * y + e.worldY);
            var R = e.parent;
            M = R.a, T = R.b, A = R.c, S = R.d;
            var I, C, _ = 1 / (M * S - T * A),
                P = x - R.worldX,
                k = E - R.worldY,
                V = (P * S - k * T) * _ - h,
                ...
                N = Math.sqrt(V * V + F * F),
                U = n.data.length * f;
            if (1e-4 > N) return this.apply1(e, r, a, !1, o, !1, l), void n.updateWorldTransformWith(y, w, 0, n.ascaleX, n.ascaleY, n.ashearX, n.ashearY);
            P = r - R.worldX, k = a - R.worldY;
            var D = (P * S - k * T) * _ - h,
                L = (k * M - P * A) * _ - u,
                Y = D * D + L * L;
            if (0 != s) {
                ...
                var X = Math.sqrt(Y),
                    B = X - N - U * c + s;
                if (B > 0) {
                    var O = Math.min(1, B / (2 * s)) - 1;
                    O = (B - s * (1 - O * O)) / X, D -= O * D, L -= O * L, Y = D * D + L * L
                }
            }
            t: if (b) {
                U *= c;
                var W = (Y - N * N - U * U) / (2 * N * U); - 1 > W ? W = -1 : W > 1 && (W = 1, o && (p *= (Math.sqrt(Y) / (N + U) - 1) * l + 1)), C = Math.acos(W) * i, M = N + U * W, T = U * Math.sin(C), I = Math.atan2(L * M - D * T, D * M + L * T)
            } else {
                M = c * U, T = d * U;
                var q = M * M,
                    H = T * T,
                ...
                if (S = j * j - 4 * Z * A, S >= 0) {
                    ...
                    var Q = z / Z,
                        $ = A / z,
                        J = Math.abs(Q) < Math.abs($) ? Q : $;
                    if (Y >= J * J) {
                        k = Math.sqrt(Y - J * J) * i, I = G - Math.atan2(k, J), C = Math.atan2(k / d, (J - N) / c);
                        break t
                    }
                }
                var K = t.MathUtils.PI,
                    te = N - M,
                    ee = te * te,
                    ne = 0,
                    re = 0,
                    ...
                    ie = ae * ae,
                    oe = 0;
                A = -M * N / (q - H), A >= -1 && 1 >= A && (A = Math.acos(A), P = M * Math.cos(A) + N, k = T * Math.sin(A), S = P * P + k * k, ee > S && (K = A, ee = S, te = P, ne = k), S > ie && (re = A, ie = S, ae = P, oe = k)), (ee + ie) / 2 >= Y ? (I = G - Math.atan2(ne * i, te), C = K * i) : (I = G - Math.atan2(oe * i, ae), C = re * i)
            }
            var se = Math.atan2(w, y) * g,
                le = e.arotation;
            I = (I - se) * t.MathUtils.radDeg + m - le, I > 180 ? I -= 360 : -180 > I && (I += 360), e.updateWorldTransformWith(h, u, le + I * l, p, e.ascaleY, 0, 0), le = n.arotation, C = ((C + se) * t.MathUtils.radDeg - n.ashearX) * g + v - le, C > 180 ? C -= 360 : -180 > C && (C += 360), n.updateWorldTransformWith(y, w, le + C * l, n.ascaleX, n.ascaleY, n.ashearX, n.ashearY)
        }, e
    }();
...
! function(t) {
    var e = function() {
        function e(t, e) {
            ...
            for (var n = 0, r = t.bones.length; r > n; n++) this.bones.push(e.findBone(t.bones[n].name));
        ...
        return e.prototype.isActive = function() {
            ...
            if (n instanceof t.PathAttachment) {
                ...
                if (i || o) {
                    var s = this.data,
                        l = s.spacingMode == t.SpacingMode.Percent,
                        h = s.rotateMode,
                        ...
                        d = u ? p : p + 1,
                        f = this.bones,
                        m = t.Utils.setArraySize(this.spaces, d),
                        v = null,
                        g = this.spacing;
                    if (c || !l) {
                        c && (v = t.Utils.setArraySize(this.lengths, p));
                        for (var y = s.spacingMode == t.SpacingMode.Length, w = 0, x = d - 1; x > w;) {
                            var E = f[w],
                                M = E.data.length;
                            if (M < e.epsilon) c && (v[w] = 0), m[++w] = 0;
                            else if (l) {
                                if (c) {
                                    var T = M * E.a,
                                        A = M * E.c,
                                ...
                                var T = M * E.a,
                                    A = M * E.c,
                                    b = Math.sqrt(T * T + A * A);
                                c && (v[w] = b), m[++w] = (y ? M + g : g) * b / M
                            }
                        }
                    } else
                        for (var w = 1; d > w; w++) m[w] = g;
                    var R = this.computeWorldPositions(n, d, u, s.positionMode == t.PositionMode.Percent, l),
                        I = R[0],
                        C = R[1],
                        _ = s.offsetRotation,
                        P = !1;
                    if (0 == _) P = h == t.RotateMode.Chain;
                    else {
                        P = !1;
                        var k = this.target.bone;
                        _ *= k.a * k.d - k.b * k.c > 0 ? t.MathUtils.degRad : -t.MathUtils.degRad
                    }
                    for (var w = 0, k = 3; p > w; w++, k += 3) {
                        var E = f[w];
                        E.worldX += (I - E.worldX) * a, E.worldY += (C - E.worldY) * a;
                        var T = R[k],
                            A = R[k + 1],
                            V = T - I,
                            F = A - C;
                        if (c) {
                            var N = v[w];
                            if (0 != N) {
                                var U = (Math.sqrt(V * V + F * F) / N - 1) * r + 1;
                                E.a *= U, E.c *= U
                            }
                        }
                        if (I = T, C = A, o) {
                            var D = E.a,
                                ...
                                O = 0,
                                W = 0;
                            if (B = u ? R[k - 1] : 0 == m[w + 1] ? R[k + 2] : Math.atan2(F, V), B -= Math.atan2(Y, D), P) {
                                O = Math.cos(B), W = Math.sin(B);
                                var q = E.data.length;
                                I += (q * (O * D - W * Y) - V) * r, C += (q * (W * D + O * Y) - F) * r
                            } else B += _;
                            B > t.MathUtils.PI ? B -= t.MathUtils.PI2 : B < -t.MathUtils.PI && (B += t.MathUtils.PI2), B *= r, O = Math.cos(B), W = Math.sin(B), E.a = O * D - W * Y, E.b = O * L - W * X, E.c = W * D + O * Y, E.d = W * L + O * X
                        }
                        E.appliedValid = !1
                    }
                }
            ...
            if (!n.constantSpeed) {
                ...
                var g = v[f];
                if (i && (l *= g), o)
                    for (var y = 1; r > y; y++) h[y] *= g;
                c = t.Utils.setArraySize(this.world, 8);
                for (var y = 0, w = 0, x = 0; r > y; y++, w += 3) {
                    var E = h[y];
                    l += E;
                    var M = l;
                    if (p) M %= g, 0 > M && (M += g), x = 0;
                    else {
                        if (0 > M) {
                            m != e.BEFORE && (m = e.BEFORE, n.computeWorldVertices(s, 2, 4, c, 0, 2)), this.addBeforePosition(M, c, 0, u, w);
                            continue
                        }
                        if (M > g) {
                            m != e.AFTER && (m = e.AFTER, n.computeWorldVertices(s, d - 6, 4, c, 0, 2)), this.addAfterPosition(M - g, c, 0, u, w);
                            continue
                        }
                    }
                    for (;; x++) {
                    ...
                    x != m && (m = x, p && x == f ? (n.computeWorldVertices(s, d - 4, 4, c, 0, 2), n.computeWorldVertices(s, 0, 4, c, 4, 2)) : n.computeWorldVertices(s, 6 * x + 2, 8, c, 0, 2)), this.addCurvePosition(M, c[0], c[1], c[2], c[3], c[4], c[5], c[6], c[7], u, w, a || y > 0 && 0 == E)
                }
                return u
            }
            ...
            for (var S = t.Utils.setArraySize(this.curves, f), b = 0, R = c[0], I = c[1], C = 0, _ = 0, P = 0, k = 0, V = 0, F = 0, N = 0, U = 0, D = 0, L = 0, Y = 0, X = 0, B = 0, O = 0, y = 0, W = 2; f > y; y++, W += 6) C = c[W], _ = c[W + 1], P = c[W + 2], k = c[W + 3], V = c[W + 4], F = c[W + 5], N = .1875 * (R - 2 * C + P), U = .1875 * (I - 2 * _ + k), D = .09375 * (3 * (C - P) - R + V), L = .09375 * (3 * (_ - k) - I + F), Y = 2 * N + D, X = 2 * U + L, B = .75 * (C - R) + N + .16666667 * D, O = .75 * (_ - I) + U + .16666667 * L, b += Math.sqrt(B * B + O * O), B += Y, O += X, Y += D, X += L, b += Math.sqrt(B * B + O * O), B += Y, O += X, b += Math.sqrt(B * B + O * O), B += Y + D, O += X + L, b += Math.sqrt(B * B + O * O), S[y] = b, R = V, I = F;
            if (l *= i ? b : b / n.lengths[f - 1], o)
                for (var y = 1; r > y; y++) h[y] *= b;
            for (var q = this.segments, H = 0, y = 0, w = 0, x = 0, G = 0; r > y; y++, w += 3) {
                var E = h[y];
                l += E;
                var M = l;
                if (p) M %= b, 0 > M && (M += b), x = 0;
                else {
                    if (0 > M) {
                        this.addBeforePosition(M, c, 0, u, w);
                        continue
                    }
                    if (M > b) {
                        this.addAfterPosition(M - b, c, d - 4, u, w);
                        continue
                    }
                }
                for (;; x++) {
                ...
                if (x != m) {
                    m = x;
                    var Z = 6 * x;
                    for (R = c[Z], I = c[Z + 1], C = c[Z + 2], _ = c[Z + 3], P = c[Z + 4], k = c[Z + 5], V = c[Z + 6], F = c[Z + 7], N = .03 * (R - 2 * C + P), U = .03 * (I - 2 * _ + k), D = .006 * (3 * (C - P) - R + V), L = .006 * (3 * (_ - k) - I + F), Y = 2 * N + D, X = 2 * U + L, B = .3 * (C - R) + N + .16666667 * D, O = .3 * (_ - I) + U + .16666667 * L, H = Math.sqrt(B * B + O * O), q[0] = H, Z = 1; 8 > Z; Z++) B += Y, O += X, Y += D, X += L, H += Math.sqrt(B * B + O * O), q[Z] = H;
                    B += Y, O += X, H += Math.sqrt(B * B + O * O), q[8] = H, B += Y + D, O += X + L, H += Math.sqrt(B * B + O * O), q[9] = H, G = 0
                }
                for (M *= H;; G++) {
                    var z = q[G];
                    if (!(M > z)) {
                ...
                this.addCurvePosition(.1 * M, R, I, C, _, P, k, V, F, u, w, a || y > 0 && 0 == E)
            }
            return u
            ...
            if (0 == t || isNaN(t)) return h[u] = e, h[u + 1] = n, void(h[u + 2] = Math.atan2(a - n, r - e));
            var p = t * t,
                d = p * t,
                f = 1 - t,
                m = f * f,
                ...
                E = e * v + r * w + i * x + s * d,
                M = n * v + a * w + o * x + l * d;
            h[u] = E, h[u + 1] = M, c && (.001 > t ? h[u + 2] = Math.atan2(a - n, r - e) : h[u + 2] = Math.atan2(M - (n * m + a * g * 2 + o * p), E - (e * m + r * g * 2 + i * p)))
...
! function(t) {
    ...
    __reflect(e.prototype, "Assets");
    var n = function() {
        function t(t) {
            void 0 === t && (t = ""), this.clientAssets = {}, this.queuedAssets = {}, this.rawAssets = {}, this.errors = {}, this.pathPrefix = t
        }
        return t.prototype.queueAsset = function(t, n, r) {
            var a = this.clientAssets[t];
            return (null === a || void 0 === a) && (a = new e(t), this.clientAssets[t] = a), null !== n && (a.textureLoader = n), a.toLoad.push(r), this.queuedAssets[r] === r ? !1 : (this.queuedAssets[r] = r, !0)
        }, t.prototype.loadText = function(t, e) {
            var n = this;
            if (e = this.pathPrefix + e, this.queueAsset(t, null, e)) {
                var r = new XMLHttpRequest;
                r.overrideMimeType("text/html"), r.onreadystatechange = function() {
                    r.readyState == XMLHttpRequest.DONE && (r.status >= 200 && r.status < 300 ? n.rawAssets[e] = r.responseText : n.errors[e] = "Couldn't load text " + e + ": status " + r.status + ", " + r.responseText)
            ...
            if (e = this.pathPrefix + e, this.queueAsset(t, null, e)) {
                var r = new XMLHttpRequest;
                r.overrideMimeType("text/html"), r.onreadystatechange = function() {
                    r.readyState == XMLHttpRequest.DONE && (r.status >= 200 && r.status < 300 ? n.rawAssets[e] = JSON.parse(r.responseText) : n.errors[e] = "Couldn't load text " + e + ": status " + r.status + ", " + r.responseText)
                }, r.open("GET", e, !0), r.send()
            }
        }, t.prototype.loadTexture = function(t, e, n) {
            var r = this;
            if (n = this.pathPrefix + n, this.queueAsset(t, e, n)) {
                var a = !("undefined" == typeof window || "undefined" == typeof navigator || !window.document),
                    i = !a && "undefined" != typeof importScripts;
                if (i) {
                    var o = {
                        mode: "cors"
                    };
                    fetch(n, o).then(function(t) {
                        return t.ok || (r.errors[n] = "Couldn't load image " + n), t.blob()
                    }).then(function(t) {
                    ...
                    var s = new Image;
                    s.crossOrigin = "anonymous", s.onload = function(t) {
                        r.rawAssets[n] = s
            ...
            return null === n || void 0 === n ? !0 : n.assets[e]
        }, t.prototype.updateClientAssets = function(t) {
            for (var e = !("undefined" == typeof window || "undefined" == typeof navigator || !window.document), n = !e && "undefined" != typeof importScripts, r = 0; r < t.toLoad.length; r++) {
                var a = t.toLoad[r],
                    i = t.assets[a];
                if (null === i || void 0 === i) {
                    var o = this.rawAssets[a];
                    if (null === o || void 0 === o) continue;
                    n ? o instanceof ImageBitmap ? t.assets[a] = t.textureLoader(o) : t.assets[a] = o : o instanceof HTMLImageElement ? t.assets[a] = t.textureLoader(o) : t.assets[a] = o
                }
            }
        }, t.prototype.isLoadingComplete = function(t) {
            var e = this.clientAssets[t];
            return null === e || void 0 === e ? !0 : (this.updateClientAssets(e), e.toLoad.length == e.loaded())
    ...
    t.SharedAssetManager = n, __reflect(n.prototype, "spine.SharedAssetManager", ["spine.Disposable"])
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
        function e(e) {
            ...
            for (var n = 0; n < e.bones.length; n++) {
                var r = e.bones[n],
                    a = void 0;
                if (null == r.parent) a = new t.Bone(r, this, null);
                else {
        ...
        return e.prototype.updateCache = function() {
            ...
            for (var e = this.bones, n = 0, r = e.length; r > n; n++) {
                var a = e[n];
                a.sorted = a.data.skinRequired, a.active = !a.sorted
            }
            if (null != this.skin)
                for (var i = this.skin.bones, n = 0, r = this.skin.bones.length; r > n; n++) {
                    var a = this.bones[i[n].index];
                    do a.sorted = !1, a.active = !0, a = a.parent; while (null != a)
                }
            var o = this.ikConstraints,
                s = this.transformConstraints,
                l = this.pathConstraints,
                h = o.length,
                u = s.length,
                c = l.length,
                p = h + u + c;
            ...
            for (var n = 0, r = e.length; r > n; n++) this.sortBone(e[n])
            ...
            if (e.active = e.target.bone.isActive() && (!e.data.skinRequired || null != this.skin && t.Utils.contains(this.skin.constraints, e.data, !0)), e.active) {
                ...
                for (var i = 0, o = this.data.skins.length; o > i; i++) this.sortPathConstraintAttachment(this.data.skins[i], r, a);
                var s = n.getAttachment();
                s instanceof t.PathAttachment && this.sortPathConstraintAttachmentWith(s, a);
                for (var l = e.bones, h = l.length, i = 0; h > i; i++) this.sortBone(l[i]);
                this._updateCache.push(e);
                for (var i = 0; h > i; i++) this.sortReset(l[i].children);
                for (var i = 0; h > i; i++) l[i].sorted = !0
            }
            ...
            if (e.active = e.target.isActive() && (!e.data.skinRequired || null != this.skin && t.Utils.contains(this.skin.constraints, e.data, !0)), e.active) {
                ...
                if (e.data.local)
                    for (var a = 0; r > a; a++) {
                        ...
                        for (var a = 0; r > a; a++) this.sortBone(n[a]);
                this._updateCache.push(e);
                for (var o = 0; r > o; o++) this.sortReset(n[o].children);
                for (var o = 0; r > o; o++) n[o].sorted = !0
            }
        }, e.prototype.sortPathConstraintAttachment = function(t, e, n) {
            var r = t.attachments[e];
            if (r)
                for (var a in r) this.sortPathConstraintAttachmentWith(r[a], n)
        }, e.prototype.sortPathConstraintAttachmentWith = function(e, n) {
            if (e instanceof t.PathAttachment) {
                var r = e.bones;
                if (null == r) this.sortBone(n);
                else
                    for (var a = this.bones, i = 0; i < r.length;)
                        for (var o = r[i++], s = i + o; s > i; i++) {
                            var l = r[i];
                            this.sortBone(a[l])
                        }
            }
            ...
            for (var t = this.updateCacheReset, e = 0, n = t.length; n > e; e++) {
                var r = t[e];
            ...
            for (var a = this._updateCache, e = 0, n = a.length; n > e; e++) a[e].update()
        }, e.prototype.setToSetupPose = function() {
            this.setBonesToSetupPose(), this.setSlotsToSetupPose()
        }, e.prototype.setBonesToSetupPose = function() {
            for (var t = this.bones, e = 0, n = t.length; n > e; e++) t[e].setToSetupPose();
            for (var r = this.ikConstraints, e = 0, n = r.length; n > e; e++) {
                var a = r[e];
            ...
            for (var i = this.transformConstraints, e = 0, n = i.length; n > e; e++) {
                var a = i[e],
                    o = a.data;
                a.rotateMix = o.rotateMix, a.translateMix = o.translateMix, a.scaleMix = o.scaleMix, a.shearMix = o.shearMix
            }
            for (var s = this.pathConstraints, e = 0, n = s.length; n > e; e++) {
                var a = s[e],
                    o = a.data;
            ...
            for (var n = 0, r = e.length; r > n; n++) e[n].setToSetupPose()
            ...
            for (var e = this.slots, n = 0, r = e.length; r > n; n++) {
                var a = e[n];
                if (a.data.name == t) return a
            }
            return null
            ...
            if (null == t) throw new Error("slotName cannot be null.");
            for (var n = this.slots, r = 0, a = n.length; a > r; r++) {
                var i = n[r];
                if (i.data.name == t) {
                    var o = null;
                    if (null != e && (o = this.getAttachment(r, e), null == o)) throw new Error("Attachment not found: " + e + ", for slot: " + t);
            ...
            for (var e = this.ikConstraints, n = 0, r = e.length; r > n; n++) {
                var a = e[n];
                if (a.data.name == t) return a
            }
            return null
            ...
            if (null == t) throw new Error("constraintName cannot be null.");
            for (var e = this.transformConstraints, n = 0, r = e.length; r > n; n++) {
                var a = e[n];
                if (a.data.name == t) return a
            }
            return null
            ...
            if (null == t) throw new Error("constraintName cannot be null.");
            for (var e = this.pathConstraints, n = 0, r = e.length; r > n; n++) {
                var a = e[n];
                if (a.data.name == t) return a
            }
            return null
            ...
            for (var a = this.drawOrder, i = Number.POSITIVE_INFINITY, o = Number.POSITIVE_INFINITY, s = Number.NEGATIVE_INFINITY, l = Number.NEGATIVE_INFINITY, h = 0, u = a.length; u > h; h++) {
                var c = a[h];
                if (c.bone.active) {
                    var p = 0,
                        d = null,
                        f = c.getAttachment();
                    if (f instanceof t.RegionAttachment) p = 8, d = t.Utils.setArraySize(r, p, 0), f.computeWorldVertices(c.bone, d, 0, 2);
                    ...
                    if (null != d)
                        for (var v = 0, g = d.length; g > v; v += 2) {
                            var y = d[v],
                                w = d[v + 1];
                            i = Math.min(i, y), o = Math.min(o, w), s = Math.max(s, y), l = Math.max(l, w)
                        }
                }
            }
...
! function(t) {
    var e = function() {
        ...
        return e.prototype.readSkeletonData = function(r) {
            ...
            i.name = "";
            var o = new n(r);
            if (i.hash = o.readString(), i.version = o.readString(), "3.8.75" == i.version) throw new Error("Unsupported skeleton data, please export with a newer version of Spine.");
            ...
            var l = 0;
            l = o.readInt(!0);
            for (var h = 0; l > h; h++) o.strings.push(o.readString());
            l = o.readInt(!0);
            for (var h = 0; l > h; h++) {
                var u = o.readString(),
                    c = 0 == h ? null : i.bones[o.readInt(!0)],
                    p = new t.BoneData(h, u, c);
                p.rotation = o.readFloat(), p.x = o.readFloat() * a, p.y = o.readFloat() * a, p.scaleX = o.readFloat(), p.scaleY = o.readFloat(), p.shearX = o.readFloat(), p.shearY = o.readFloat(), p.length = o.readFloat() * a, p.transformMode = e.TransformModeValues[o.readInt(!0)], p.skinRequired = o.readBoolean(), s && t.Color.rgba8888ToColor(p.color, o.readInt32()), i.bones.push(p)
            }
            l = o.readInt(!0);
            for (var h = 0; l > h; h++) {
                var d = o.readString(),
                    f = i.bones[o.readInt(!0)],
                    p = new t.SlotData(h, d, f);
                t.Color.rgba8888ToColor(p.color, o.readInt32());
                var m = o.readInt32(); - 1 != m && t.Color.rgb888ToColor(p.darkColor = new t.Color, m), p.attachmentName = o.readStringRef(), p.blendMode = e.BlendModeValues[o.readInt(!0)], i.slots.push(p)
            }
            l = o.readInt(!0);
            for (var h = 0, v = void 0; l > h; h++) {
                var p = new t.IkConstraintData(o.readString());
                p.order = o.readInt(!0), p.skinRequired = o.readBoolean(), v = o.readInt(!0);
                for (var g = 0; v > g; g++) p.bones.push(i.bones[o.readInt(!0)]);
                p.target = i.bones[o.readInt(!0)], p.mix = o.readFloat(), p.softness = o.readFloat() * a, p.bendDirection = o.readByte(), p.compress = o.readBoolean(), p.stretch = o.readBoolean(), p.uniform = o.readBoolean(), i.ikConstraints.push(p)
            }
            l = o.readInt(!0);
            for (var h = 0, v = void 0; l > h; h++) {
                var p = new t.TransformConstraintData(o.readString());
                p.order = o.readInt(!0), p.skinRequired = o.readBoolean(), v = o.readInt(!0);
                for (var g = 0; v > g; g++) p.bones.push(i.bones[o.readInt(!0)]);
                p.target = i.bones[o.readInt(!0)], p.local = o.readBoolean(), p.relative = o.readBoolean(), p.offsetRotation = o.readFloat(), p.offsetX = o.readFloat() * a, p.offsetY = o.readFloat() * a, p.offsetScaleX = o.readFloat(), p.offsetScaleY = o.readFloat(), p.offsetShearY = o.readFloat(), p.rotateMix = o.readFloat(), p.translateMix = o.readFloat(), p.scaleMix = o.readFloat(), p.shearMix = o.readFloat(), i.transformConstraints.push(p)
            }
            l = o.readInt(!0);
            for (var h = 0, v = void 0; l > h; h++) {
                var p = new t.PathConstraintData(o.readString());
                p.order = o.readInt(!0), p.skinRequired = o.readBoolean(), v = o.readInt(!0);
                for (var g = 0; v > g; g++) p.bones.push(i.bones[o.readInt(!0)]);
                p.target = i.slots[o.readInt(!0)], p.positionMode = e.PositionModeValues[o.readInt(!0)], p.spacingMode = e.SpacingModeValues[o.readInt(!0)], p.rotateMode = e.RotateModeValues[o.readInt(!0)], p.offsetRotation = o.readFloat(), p.position = o.readFloat(), p.positionMode == t.PositionMode.Fixed && (p.position *= a), p.spacing = o.readFloat(), (p.spacingMode == t.SpacingMode.Length || p.spacingMode == t.SpacingMode.Fixed) && (p.spacing *= a), p.rotateMix = o.readFloat(), p.translateMix = o.readFloat(), i.pathConstraints.push(p)
            }
            var y = this.readSkin(o, i, !0, s);
            null != y && (i.defaultSkin = y, i.skins.push(y));
            var h = i.skins.length;
            for (t.Utils.setArraySize(i.skins, l = h + o.readInt(!0)); l > h; h++) i.skins[h] = this.readSkin(o, i, !1, s);
            l = this.linkedMeshes.length;
            for (var h = 0; l > h; h++) {
                var w = this.linkedMeshes[h],
                    x = null == w.skin ? i.defaultSkin : i.findSkin(w.skin);
                if (null == x) throw new Error("Skin not found: " + w.skin);
                var E = x.getAttachment(w.slotIndex, w.parent);
                if (null == E) throw new Error("Parent mesh not found: " + w.parent);
                w.mesh.deformAttachment = w.inheritDeform ? E : w.mesh, w.mesh.setParentMesh(E), w.mesh.updateUVs()
            }
            this.linkedMeshes.length = 0, l = o.readInt(!0);
            for (var h = 0; l > h; h++) {
                var p = new t.EventData(o.readStringRef());
                p.intValue = o.readInt(!1), p.floatValue = o.readFloat(), p.stringValue = o.readString(), p.audioPath = o.readString(), null != p.audioPath && (p.volume = o.readFloat(), p.balance = o.readFloat()), i.events.push(p)
            }
            l = o.readInt(!0);
            for (var h = 0; l > h; h++) i.animations.push(this.readAnimation(o, o.readString(), i));
            return i
        }, e.prototype.readSkin = function(e, n, r, a) {
            var i = null,
                o = 0;
            if (r) {
                if (o = e.readInt(!0), 0 == o) return null;
                i = new t.Skin("default")
            } else {
                i = new t.Skin(e.readStringRef()), i.bones.length = e.readInt(!0);
                for (var s = 0, l = i.bones.length; l > s; s++) i.bones[s] = n.bones[e.readInt(!0)];
                for (var s = 0, l = e.readInt(!0); l > s; s++) i.constraints.push(n.ikConstraints[e.readInt(!0)]);
                for (var s = 0, l = e.readInt(!0); l > s; s++) i.constraints.push(n.transformConstraints[e.readInt(!0)]);
                for (var s = 0, l = e.readInt(!0); l > s; s++) i.constraints.push(n.pathConstraints[e.readInt(!0)]);
                o = e.readInt(!0)
            }
            for (var s = 0; o > s; s++)
                for (var h = e.readInt(!0), u = 0, c = e.readInt(!0); c > u; u++) {
                    var p = e.readStringRef(),
                        d = this.readAttachment(e, n, i, h, p, a);
            ...
            switch (p) {
                case t.AttachmentType.Region:
                    var d = n.readStringRef(),
                        ...
                        E = n.readInt32();
                    null == d && (d = u);
                    var M = this.attachmentLoader.newRegionAttachment(i, u, d);
                    return null == M ? null : (M.path = d, M.x = m * h, M.y = v * h, M.scaleX = g, M.scaleY = y, M.rotation = f, M.width = w * h, M.height = x * h, t.Color.rgba8888ToColor(M.color, E), M.updateOffset(), M);
                case t.AttachmentType.BoundingBox:
                    var T = n.readInt(!0),
                        A = this.readVertices(n, T),
                        E = l ? n.readInt32() : 0,
                        S = this.attachmentLoader.newBoundingBoxAttachment(i, u);
                    return null == S ? null : (S.worldVerticesLength = T << 1, S.vertices = A.vertices, S.bones = A.bones, l && t.Color.rgba8888ToColor(S.color, E), S);
                case t.AttachmentType.Mesh:
                    var d = n.readStringRef(),
                        E = n.readInt32(),
                        T = n.readInt(!0),
                        b = this.readFloatArray(n, T << 1, 1),
                        ...
                        w = 0,
                        x = 0;
                    l && (C = this.readShortArray(n), w = n.readFloat(), x = n.readFloat()), null == d && (d = u);
                    var _ = this.attachmentLoader.newMeshAttachment(i, u, d);
                    return null == _ ? null : (_.path = d, t.Color.rgba8888ToColor(_.color, E), _.bones = A.bones, _.vertices = A.vertices, _.worldVerticesLength = T << 1, _.triangles = R, _.regionUVs = b, _.updateUVs(), _.hullLength = I << 1, l && (_.edges = C, _.width = w * h, _.height = x * h), _);
                case t.AttachmentType.LinkedMesh:
                    var d = n.readStringRef(),
                        ...
                        w = 0,
                        x = 0;
                    l && (w = n.readFloat(), x = n.readFloat()), null == d && (d = u);
                    var _ = this.attachmentLoader.newMeshAttachment(i, u, d);
                    return null == _ ? null : (_.path = d, t.Color.rgba8888ToColor(_.color, E), l && (_.width = w * h, _.height = x * h), this.linkedMeshes.push(new r(_, P, o, k, V)), _);
                case t.AttachmentType.Path:
                    for (var F = n.readBoolean(), N = n.readBoolean(), T = n.readInt(!0), A = this.readVertices(n, T), U = t.Utils.newArray(T / 3, 0), D = 0, L = U.length; L > D; D++) U[D] = n.readFloat() * h;
                    var E = l ? n.readInt32() : 0,
                        d = this.attachmentLoader.newPathAttachment(i, u);
                    return null == d ? null : (d.closed = F, d.constantSpeed = N, d.worldVerticesLength = T << 1, d.vertices = A.vertices, d.bones = A.bones, d.lengths = U, l && t.Color.rgba8888ToColor(d.color, E), d);
                case t.AttachmentType.Point:
                    var f = n.readFloat(),
                        m = n.readFloat(),
                        v = n.readFloat(),
                        E = l ? n.readInt32() : 0,
                        Y = this.attachmentLoader.newPointAttachment(i, u);
                    return null == Y ? null : (Y.x = m * h, Y.y = v * h, Y.rotation = f, l && t.Color.rgba8888ToColor(Y.color, E), Y);
                case t.AttachmentType.Clipping:
                    var X = n.readInt(!0),
                        T = n.readInt(!0),
                        A = this.readVertices(n, T),
                        E = l ? n.readInt32() : 0,
                        B = this.attachmentLoader.newClippingAttachment(i, u);
                    return null == B ? null : (B.endSlot = a.slots[X], B.worldVerticesLength = T << 1, B.vertices = A.vertices, B.bones = A.bones, l && t.Color.rgba8888ToColor(B.color, E), B)
            }
            return null
            ...
            for (var s = new Array, l = new Array, h = 0; n > h; h++) {
                var u = e.readInt(!0);
                l.push(u);
                for (var c = 0; u > c; c++) l.push(e.readInt(!0)), s.push(e.readFloat() * o), s.push(e.readFloat() * o), s.push(e.readFloat())
            }
            return i.vertices = t.Utils.toFloatArray(s), i.bones = l, i
        }, e.prototype.readFloatArray = function(t, e, n) {
            var r = new Array(e);
            if (1 == n)
                for (var a = 0; e > a; a++) r[a] = t.readFloat();
            else
                for (var a = 0; e > a; a++) r[a] = t.readFloat() * n;
            return r
        }, e.prototype.readShortArray = function(t) {
            for (var e = t.readInt(!0), n = new Array(e), r = 0; e > r; r++) n[r] = t.readShort();
            return n
        }, e.prototype.readAnimation = function(n, r, a) {
            for (var i = new Array, o = this.scale, s = 0, l = new t.Color, h = new t.Color, u = 0, c = n.readInt(!0); c > u; u++)
                for (var p = n.readInt(!0), d = 0, f = n.readInt(!0); f > d; d++) {
                    var m = n.readByte(),
                        v = n.readInt(!0);
                    switch (m) {
                        case e.SLOT_ATTACHMENT:
                            var g = new t.AttachmentTimeline(v);
                            g.slotIndex = p;
                            for (var y = 0; v > y; y++) g.setFrame(y, n.readFloat(), n.readStringRef());
                            i.push(g), s = Math.max(s, g.frames[v - 1]);
                            break;
                        case e.SLOT_COLOR:
                            var g = new t.ColorTimeline(v);
                            g.slotIndex = p;
                            for (var y = 0; v > y; y++) {
                                var w = n.readFloat();
                                t.Color.rgba8888ToColor(l, n.readInt32()), g.setFrame(y, w, l.r, l.g, l.b, l.a), v - 1 > y && this.readCurve(n, y, g)
                            }
                            i.push(g), s = Math.max(s, g.frames[(v - 1) * t.ColorTimeline.ENTRIES]);
                            break;
                        case e.SLOT_TWO_COLOR:
                            var g = new t.TwoColorTimeline(v);
                            g.slotIndex = p;
                            for (var y = 0; v > y; y++) {
                                var w = n.readFloat();
                                t.Color.rgba8888ToColor(l, n.readInt32()), t.Color.rgb888ToColor(h, n.readInt32()), g.setFrame(y, w, l.r, l.g, l.b, l.a, h.r, h.g, h.b), v - 1 > y && this.readCurve(n, y, g)
                            }
                            i.push(g), s = Math.max(s, g.frames[(v - 1) * t.TwoColorTimeline.ENTRIES])
                    }
                }
            for (var u = 0, c = n.readInt(!0); c > u; u++)
                for (var x = n.readInt(!0), d = 0, f = n.readInt(!0); f > d; d++) {
                    var m = n.readByte(),
                        v = n.readInt(!0);
                    switch (m) {
                        case e.BONE_ROTATE:
                            var g = new t.RotateTimeline(v);
                            g.boneIndex = x;
                            for (var y = 0; v > y; y++) g.setFrame(y, n.readFloat(), n.readFloat()), v - 1 > y && this.readCurve(n, y, g);
                            i.push(g), s = Math.max(s, g.frames[(v - 1) * t.RotateTimeline.ENTRIES]);
                            break;
                        ...
                        case e.BONE_SHEAR:
                            var g = void 0,
                                E = 1;
                            m == e.BONE_SCALE ? g = new t.ScaleTimeline(v) : m == e.BONE_SHEAR ? g = new t.ShearTimeline(v) : (g = new t.TranslateTimeline(v), E = o), g.boneIndex = x;
                            for (var y = 0; v > y; y++) g.setFrame(y, n.readFloat(), n.readFloat() * E, n.readFloat() * E), v - 1 > y && this.readCurve(n, y, g);
                            i.push(g), s = Math.max(s, g.frames[(v - 1) * t.TranslateTimeline.ENTRIES])
                    }
                }
            for (var u = 0, c = n.readInt(!0); c > u; u++) {
                var M = n.readInt(!0),
                    v = n.readInt(!0),
                    g = new t.IkConstraintTimeline(v);
                g.ikConstraintIndex = M;
                for (var y = 0; v > y; y++) g.setFrame(y, n.readFloat(), n.readFloat(), n.readFloat() * o, n.readByte(), n.readBoolean(), n.readBoolean()), v - 1 > y && this.readCurve(n, y, g);
                i.push(g), s = Math.max(s, g.frames[(v - 1) * t.IkConstraintTimeline.ENTRIES])
            }
            for (var u = 0, c = n.readInt(!0); c > u; u++) {
                var M = n.readInt(!0),
                    v = n.readInt(!0),
                    g = new t.TransformConstraintTimeline(v);
                g.transformConstraintIndex = M;
                for (var y = 0; v > y; y++) g.setFrame(y, n.readFloat(), n.readFloat(), n.readFloat(), n.readFloat(), n.readFloat()), v - 1 > y && this.readCurve(n, y, g);
                i.push(g), s = Math.max(s, g.frames[(v - 1) * t.TransformConstraintTimeline.ENTRIES])
            }
            for (var u = 0, c = n.readInt(!0); c > u; u++)
                for (var M = n.readInt(!0), T = a.pathConstraints[M], d = 0, f = n.readInt(!0); f > d; d++) {
                    var m = n.readByte(),
                        v = n.readInt(!0);
                    switch (m) {
                        ...
                        case e.PATH_SPACING:
                            var g = void 0,
                                E = 1;
                            m == e.PATH_SPACING ? (g = new t.PathConstraintSpacingTimeline(v), (T.spacingMode == t.SpacingMode.Length || T.spacingMode == t.SpacingMode.Fixed) && (E = o)) : (g = new t.PathConstraintPositionTimeline(v), T.positionMode == t.PositionMode.Fixed && (E = o)), g.pathConstraintIndex = M;
                            for (var y = 0; v > y; y++) g.setFrame(y, n.readFloat(), n.readFloat() * E), v - 1 > y && this.readCurve(n, y, g);
                            i.push(g), s = Math.max(s, g.frames[(v - 1) * t.PathConstraintPositionTimeline.ENTRIES]);
                            break;
                        case e.PATH_MIX:
                            var g = new t.PathConstraintMixTimeline(v);
                            g.pathConstraintIndex = M;
                            for (var y = 0; v > y; y++) g.setFrame(y, n.readFloat(), n.readFloat(), n.readFloat()), v - 1 > y && this.readCurve(n, y, g);
                            i.push(g), s = Math.max(s, g.frames[(v - 1) * t.PathConstraintMixTimeline.ENTRIES])
                    }
                }
            for (var u = 0, c = n.readInt(!0); c > u; u++)
                for (var A = a.skins[n.readInt(!0)], d = 0, f = n.readInt(!0); f > d; d++)
                    for (var p = n.readInt(!0), S = 0, b = n.readInt(!0); b > S; S++) {
                        var R = A.getAttachment(p, n.readStringRef()),
                            I = null != R.bones,
                            C = R.vertices,
                            _ = I ? C.length / 3 * 2 : C.length,
                            v = n.readInt(!0),
                            g = new t.DeformTimeline(v);
                        g.slotIndex = p, g.attachment = R;
                        for (var y = 0; v > y; y++) {
                            var w = n.readFloat(),
                                P = void 0,
                                k = n.readInt(!0);
                            if (0 == k) P = I ? t.Utils.newFloatArray(_) : C;
                            else {
                                P = t.Utils.newFloatArray(_);
                                var V = n.readInt(!0);
                                if (k += V, 1 == o)
                                    for (var F = V; k > F; F++) P[F] = n.readFloat();
                                else
                                    for (var F = V; k > F; F++) P[F] = n.readFloat() * o;
                                if (!I)
                                    for (var F = 0, N = P.length; N > F; F++) P[F] += C[F]
                            }
                            g.setFrame(y, w, P), v - 1 > y && this.readCurve(n, y, g)
                        }
                        i.push(g), s = Math.max(s, g.frames[v - 1])
                    }
            var U = n.readInt(!0);
            if (U > 0) {
                for (var g = new t.DrawOrderTimeline(U), D = a.slots.length, u = 0; U > u; u++) {
                    for (var w = n.readFloat(), L = n.readInt(!0), Y = t.Utils.newArray(D, 0), d = D - 1; d >= 0; d--) Y[d] = -1;
                    for (var X = t.Utils.newArray(D - L, 0), B = 0, O = 0, d = 0; L > d; d++) {
                        for (var p = n.readInt(!0); B != p;) X[O++] = B++;
                        Y[B + n.readInt(!0)] = B++
                    }
                    for (; D > B;) X[O++] = B++;
                    for (var d = D - 1; d >= 0; d--) - 1 == Y[d] && (Y[d] = X[--O]);
                    g.setFrame(u, w, Y)
                }
                i.push(g), s = Math.max(s, g.frames[U - 1])
            }
            var W = n.readInt(!0);
            if (W > 0) {
                for (var g = new t.EventTimeline(W), u = 0; W > u; u++) {
                    var w = n.readFloat(),
                        q = a.events[n.readInt(!0)],
                        H = new t.Event(w, q);
                    H.intValue = n.readInt(!1), H.floatValue = n.readFloat(), H.stringValue = n.readBoolean() ? n.readString() : q.stringValue, null != H.data.audioPath && (H.volume = n.readFloat(), H.balance = n.readFloat()), g.setFrame(u, H)
                }
                i.push(g), s = Math.max(s, g.frames[W - 1])
            }
    ...
    t.SkeletonBinary = e, __reflect(e.prototype, "spine.SkeletonBinary");
    var n = function() {
        function t(t, e, n, r) {
        ...
        return t.prototype.readByte = function() {
            ...
            var e = this.readByte(),
                n = 127 & e;
            return 0 != (128 & e) && (e = this.readByte(), n |= (127 & e) << 7, 0 != (128 & e) && (e = this.readByte(), n |= (127 & e) << 14, 0 != (128 & e) && (e = this.readByte(), n |= (127 & e) << 21, 0 != (128 & e) && (e = this.readByte(), n |= (127 & e) << 28)))), t ? n : n >>> 1 ^ -(1 & n)
    ...
    __reflect(n.prototype, "BinaryInput");
    var r = function() {
    ...
    __reflect(r.prototype, "LinkedMesh");
    var a = function() {
        function t(t, e) {
    ...
    __reflect(a.prototype, "Vertices")
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
        ...
        return e.prototype.update = function(e, n) {
            ...
            for (var t = Number.POSITIVE_INFINITY, e = Number.POSITIVE_INFINITY, n = Number.NEGATIVE_INFINITY, r = Number.NEGATIVE_INFINITY, a = this.polygons, i = 0, o = a.length; o > i; i++)
                for (var s = a[i], l = s, h = 0, u = s.length; u > h; h += 2) {
                    var c = l[h],
                        p = l[h + 1];
            ...
            for (var a = this.polygons, i = 0, o = a.length; o > i; i++)
                if (this.intersectsSegmentPolygon(a[i], t, e, n, r)) return this.boundingBoxes[i];
            return null
        }, e.prototype.intersectsSegmentPolygon = function(t, e, n, r, a) {
            for (var i = t, o = t.length, s = e - r, l = n - a, h = e * a - n * r, u = i[o - 2], c = i[o - 1], p = 0; o > p; p += 2) {
                var d = i[p],
                    f = i[p + 1],
                    m = u * f - c * d,
                    v = u - d,
                    ...
                    y = s * g - l * v,
                    w = (h * v - s * m) / y;
                if ((w >= u && d >= w || w >= d && u >= w) && (w >= e && r >= w || w >= r && e >= w)) {
                    var x = (h * g - l * m) / y;
                    if ((x >= c && f >= x || x >= f && c >= x) && (x >= n && a >= x || x >= a && n >= x)) return !0
                }
                u = d, c = f
            }
            return !1
...
! function(t) {
    var e = function(t) {
        function e(e, n) {
            ...
            return r.animations = [], r.disposed = !1, r.loop = 0, r.trackID = n, r.skelAnimation = e, r.stateListener = {
                complete: function() {
                    return r.onComplete()
                },
                interrupt: function() {
        ...
        return __extends(e, t), e.prototype.waitPlayStart = function() {
            var t = this;
            ...
            this.trackEntry && (this.trackEntry.listener = null), this.trackEntry = this.skelAnimation.state.setAnimation(this.trackID, t, e), this.trackEntry.listener = this.stateListener, this.skelAnimation.renderer.update(0)
        }, e.prototype.playNextAnimation = function() {
            if (!this.disposed && this.animations.length > 0) {
                var t = this.animations[0],
                    e = t.name,
                    n = t.listener;
                n && (n.playStart && this.on(0, n.playStart, n), n.playEnd && this.on(1, n.playEnd, n), n.loopStart && this.on(2, n.loopStart, n), n.loopEnd && this.on(3, n.loopEnd, n), n.interrupt && this.on(4, n.interrupt, n), n.custom && this.on(5, n.custom, n)), this.loop = 0, this.setAnimation(e, !1), this.emit(0), this.emit(2)
            }
        }, e.prototype.onComplete = function() {
            if (!this.disposed) {
                var t = this.animations[0];
                if (this.emit(3), ++this.loop != t.loop) this.setAnimation(t.name, !1), this.emit(2);
                else {
                    var e = t.listener;
                    this.emit(1), this.animations.shift(), e && (this.off(0, e.playStart), this.off(1, e.playEnd), this.off(2, e.loopStart), this.off(3, e.loopEnd), this.off(4, e.interrupt), this.off(5, e.custom)), this.animations.length > 0 ? this.playNextAnimation() : (this.disposed = !0, this.trackEntry.listener = null, this.trackEntry = null, this.emit(6))
                }
            }
...
! function(t) {
    var e = function() {
        ...
        return t.prototype.findBone = function(t) {
            ...
            for (var e = this.skins, n = 0, r = e.length; r > n; n++) {
                var a = e[n];
                if (a.name == t) return a
            }
            return null
            ...
            for (var e = this.events, n = 0, r = e.length; r > n; n++) {
                var a = e[n];
                if (a.name == t) return a
            }
            return null
            ...
            for (var e = this.animations, n = 0, r = e.length; r > n; n++) {
                var a = e[n];
                if (a.name == t) return a
            }
            return null
...
! function(t) {
    var e = function() {
        ...
        return e.prototype.readSkeletonData = function(n) {
            var r = this.scale,
                ...
                o = i.skeleton;
            if (null != o) {
                if (a.hash = o.hash, a.version = o.spine, "3.8.75" == a.version) throw new Error("Unsupported skeleton data, please export with a newer version of Spine.");
            ...
            if (i.bones)
                for (var s = 0; s < i.bones.length; s++) {
                    ...
                    if (null != u && (h = a.findBone(u), null == h)) throw new Error("Parent bone not found: " + u);
                    var c = new t.BoneData(a.bones.length, l.name, h);
                    c.length = this.getValue(l, "length", 0) * r, c.x = this.getValue(l, "x", 0) * r, c.y = this.getValue(l, "y", 0) * r, c.rotation = this.getValue(l, "rotation", 0), c.scaleX = this.getValue(l, "scaleX", 1), c.scaleY = this.getValue(l, "scaleY", 1), c.shearX = this.getValue(l, "shearX", 0), c.shearY = this.getValue(l, "shearY", 0), c.transformMode = e.transformModeFromString(this.getValue(l, "transform", "normal")), c.skinRequired = this.getValue(l, "skin", !1), a.bones.push(c)
                }
            if (i.slots)
                for (var s = 0; s < i.slots.length; s++) {
                    var p = i.slots[s],
                        ...
                        f = p.bone,
                        m = a.findBone(f);
                    if (null == m) throw new Error("Slot bone not found: " + f);
                    var c = new t.SlotData(a.slots.length, d, m),
                        v = this.getValue(p, "color", null);
                    null != v && c.color.setFromString(v);
                    var g = this.getValue(p, "dark", null);
                    null != g && (c.darkColor = new t.Color(1, 1, 1, 1), c.darkColor.setFromString(g)), c.attachmentName = this.getValue(p, "attachment", null), c.blendMode = e.blendModeFromString(this.getValue(p, "blend", "normal")), a.slots.push(c)
                }
            if (i.ik)
                for (var s = 0; s < i.ik.length; s++) {
                    var y = i.ik[s],
                        c = new t.IkConstraintData(y.name);
                    c.order = this.getValue(y, "order", 0), c.skinRequired = this.getValue(y, "skin", !1);
                    for (var w = 0; w < y.bones.length; w++) {
                        var f = y.bones[w],
                            x = a.findBone(f);
                    ...
                    var E = y.target;
                    if (c.target = a.findBone(E), null == c.target) throw new Error("IK target bone not found: " + E);
                    c.mix = this.getValue(y, "mix", 1), c.softness = this.getValue(y, "softness", 0) * r, c.bendDirection = this.getValue(y, "bendPositive", !0) ? 1 : -1, c.compress = this.getValue(y, "compress", !1), c.stretch = this.getValue(y, "stretch", !1), c.uniform = this.getValue(y, "uniform", !1), a.ikConstraints.push(c)
                }
            if (i.transform)
                for (var s = 0; s < i.transform.length; s++) {
                    var y = i.transform[s],
                        c = new t.TransformConstraintData(y.name);
                    c.order = this.getValue(y, "order", 0), c.skinRequired = this.getValue(y, "skin", !1);
                    for (var w = 0; w < y.bones.length; w++) {
                        var f = y.bones[w],
                            x = a.findBone(f);
                    ...
                    var E = y.target;
                    if (c.target = a.findBone(E), null == c.target) throw new Error("Transform constraint target bone not found: " + E);
                    c.local = this.getValue(y, "local", !1), c.relative = this.getValue(y, "relative", !1), c.offsetRotation = this.getValue(y, "rotation", 0), c.offsetX = this.getValue(y, "x", 0) * r, c.offsetY = this.getValue(y, "y", 0) * r, c.offsetScaleX = this.getValue(y, "scaleX", 0), c.offsetScaleY = this.getValue(y, "scaleY", 0), c.offsetShearY = this.getValue(y, "shearY", 0), c.rotateMix = this.getValue(y, "rotateMix", 1), c.translateMix = this.getValue(y, "translateMix", 1), c.scaleMix = this.getValue(y, "scaleMix", 1), c.shearMix = this.getValue(y, "shearMix", 1), a.transformConstraints.push(c)
                }
            if (i.path)
                for (var s = 0; s < i.path.length; s++) {
                    var y = i.path[s],
                        c = new t.PathConstraintData(y.name);
                    c.order = this.getValue(y, "order", 0), c.skinRequired = this.getValue(y, "skin", !1);
                    for (var w = 0; w < y.bones.length; w++) {
                        var f = y.bones[w],
                            x = a.findBone(f);
                    ...
                    var E = y.target;
                    if (c.target = a.findSlot(E), null == c.target) throw new Error("Path target slot not found: " + E);
                    c.positionMode = e.positionModeFromString(this.getValue(y, "positionMode", "percent")), c.spacingMode = e.spacingModeFromString(this.getValue(y, "spacingMode", "length")), c.rotateMode = e.rotateModeFromString(this.getValue(y, "rotateMode", "tangent")), c.offsetRotation = this.getValue(y, "rotation", 0), c.position = this.getValue(y, "position", 0), c.positionMode == t.PositionMode.Fixed && (c.position *= r), c.spacing = this.getValue(y, "spacing", 0), (c.spacingMode == t.SpacingMode.Length || c.spacingMode == t.SpacingMode.Fixed) && (c.spacing *= r), c.rotateMix = this.getValue(y, "rotateMix", 1), c.translateMix = this.getValue(y, "translateMix", 1), a.pathConstraints.push(c)
                }
            if (i.skins)
                for (var s = 0; s < i.skins.length; s++) {
                    var M = i.skins[s],
                        T = new t.Skin(M.name);
                    if (M.bones)
                        for (var A = 0; A < M.bones.length; A++) {
                            var x = a.findBone(M.bones[A]);
                            if (null == x) throw new Error("Skin bone not found: " + M.bones[s]);
                            T.bones.push(x)
                        }
                    if (M.ik)
                        for (var A = 0; A < M.ik.length; A++) {
                            var S = a.findIkConstraint(M.ik[A]);
                            if (null == S) throw new Error("Skin IK constraint not found: " + M.ik[s]);
                            T.constraints.push(S)
                        }
                    if (M.transform)
                        for (var A = 0; A < M.transform.length; A++) {
                            var S = a.findTransformConstraint(M.transform[A]);
                            if (null == S) throw new Error("Skin transform constraint not found: " + M.transform[s]);
                            T.constraints.push(S)
                        }
                    if (M.path)
                        for (var A = 0; A < M.path.length; A++) {
                            var S = a.findPathConstraint(M.path[A]);
                            if (null == S) throw new Error("Skin path constraint not found: " + M.path[s]);
                            T.constraints.push(S)
                        }
                    for (var d in M.attachments) {
                        var b = a.findSlot(d);
                        if (null == b) throw new Error("Slot not found: " + d);
                        var p = M.attachments[d];
                        for (var R in p) {
                            var I = this.readAttachment(p[R], T, b.index, R, a);
                            null != I && T.setAttachment(b.index, R, I)
                        }
                    }
                    a.skins.push(T), "default" == T.name && (a.defaultSkin = T)
                }
            for (var s = 0, C = this.linkedMeshes.length; C > s; s++) {
                var _ = this.linkedMeshes[s],
                    T = null == _.skin ? a.defaultSkin : a.findSkin(_.skin);
                if (null == T) throw new Error("Skin not found: " + _.skin);
                var P = T.getAttachment(_.slotIndex, _.parent);
                if (null == P) throw new Error("Parent mesh not found: " + _.parent);
                _.mesh.deformAttachment = _.inheritDeform ? P : _.mesh, _.mesh.setParentMesh(P), _.mesh.updateUVs()
            }
            if (this.linkedMeshes.length = 0, i.events)
                for (var k in i.events) {
                    var V = i.events[k],
                        c = new t.EventData(k);
                    c.intValue = this.getValue(V, "int", 0), c.floatValue = this.getValue(V, "float", 0), c.stringValue = this.getValue(V, "string", ""), c.audioPath = this.getValue(V, "audio", null), null != c.audioPath && (c.volume = this.getValue(V, "volume", 1), c.balance = this.getValue(V, "balance", 0)), a.events.push(c)
                }
            if (i.animations)
                for (var F in i.animations) {
                    var N = i.animations[F];
                    this.readAnimation(N, F, a)
                }
            return a
        }, e.prototype.readAttachment = function(e, r, a, i, o) {
            var s = this.scale;
            i = this.getValue(e, "name", i);
            var l = this.getValue(e, "type", "region");
            switch (l) {
                case "region":
                    var h = this.getValue(e, "path", i),
                        u = this.attachmentLoader.newRegionAttachment(r, i, h);
                    if (null == u) return null;
                    u.path = h, u.x = this.getValue(e, "x", 0) * s, u.y = this.getValue(e, "y", 0) * s, u.scaleX = this.getValue(e, "scaleX", 1), u.scaleY = this.getValue(e, "scaleY", 1), u.rotation = this.getValue(e, "rotation", 0), u.width = e.width * s, u.height = e.height * s;
                    var c = this.getValue(e, "color", null);
                    return null != c && u.color.setFromString(c), u.updateOffset(), u;
                case "boundingbox":
                    var p = this.attachmentLoader.newBoundingBoxAttachment(r, i);
                    if (null == p) return null;
                    this.readVertices(e, p, e.vertexCount << 1);
                    var c = this.getValue(e, "color", null);
                    return null != c && p.color.setFromString(c), p;
                case "mesh":
                case "linkedmesh":
                    var h = this.getValue(e, "path", i),
                        d = this.attachmentLoader.newMeshAttachment(r, i, h);
                    if (null == d) return null;
                    d.path = h;
                    var c = this.getValue(e, "color", null);
                    null != c && d.color.setFromString(c), d.width = this.getValue(e, "width", 0) * s, d.height = this.getValue(e, "height", 0) * s;
                    var f = this.getValue(e, "parent", null);
                    if (null != f) return this.linkedMeshes.push(new n(d, this.getValue(e, "skin", null), a, f, this.getValue(e, "deform", !0))), d;
                    var m = e.uvs;
                    return this.readVertices(e, d, m.length), d.triangles = e.triangles, d.regionUVs = m, d.updateUVs(), d.edges = this.getValue(e, "edges", null), d.hullLength = 2 * this.getValue(e, "hull", 0), d;
                case "path":
                    var h = this.attachmentLoader.newPathAttachment(r, i);
                    if (null == h) return null;
                    h.closed = this.getValue(e, "closed", !1), h.constantSpeed = this.getValue(e, "constantSpeed", !0);
                    var v = e.vertexCount;
                    this.readVertices(e, h, v << 1);
                    for (var g = t.Utils.newArray(v / 3, 0), y = 0; y < e.lengths.length; y++) g[y] = e.lengths[y] * s;
                    h.lengths = g;
                    var c = this.getValue(e, "color", null);
                    return null != c && h.color.setFromString(c), h;
                case "point":
                    var w = this.attachmentLoader.newPointAttachment(r, i);
                    if (null == w) return null;
                    w.x = this.getValue(e, "x", 0) * s, w.y = this.getValue(e, "y", 0) * s, w.rotation = this.getValue(e, "rotation", 0);
                    var c = this.getValue(e, "color", null);
                    return null != c && w.color.setFromString(c), w;
                case "clipping":
                    var x = this.attachmentLoader.newClippingAttachment(r, i);
                    if (null == x) return null;
                    var E = this.getValue(e, "end", null);
                    if (null != E) {
                        var M = o.findSlot(E);
                        if (null == M) throw new Error("Clipping end slot not found: " + E);
                        x.endSlot = M
                    }
                    var v = e.vertexCount;
            ...
            var i = e.vertices;
            if (r == i.length) {
                var o = t.Utils.toFloatArray(i);
                if (1 != a)
                    for (var s = 0, l = i.length; l > s; s++) o[s] *= a;
                return void(n.vertices = o)
            }
            for (var h = new Array, u = new Array, s = 0, l = i.length; l > s;) {
                var c = i[s++];
                u.push(c);
                for (var p = s + 4 * c; p > s; s += 4) u.push(i[s]), h.push(i[s + 1] * a), h.push(i[s + 2] * a), h.push(i[s + 3])
            }
                    ...
                    for (var u in l) {
                        ...
                        if ("attachment" == u) {
                            ...
                            for (var d = 0, f = 0; f < c.length; f++) {
                                var m = c[f];
                                p.setFrame(d++, this.getValue(m, "time", 0), m.name)
                            }
                            i.push(p), o = Math.max(o, p.frames[p.getFrameCount() - 1])
                        } else if ("color" == u) {
                            ...
                            for (var d = 0, f = 0; f < c.length; f++) {
                                var m = c[f],
                                    v = new t.Color;
                                v.setFromString(m.color), p.setFrame(d, this.getValue(m, "time", 0), v.r, v.g, v.b, v.a), this.readCurve(m, p, d), d++
                            }
                            i.push(p), o = Math.max(o, p.frames[(p.getFrameCount() - 1) * t.ColorTimeline.ENTRIES])
                        } else {
                            ...
                            for (var d = 0, f = 0; f < c.length; f++) {
                                var m = c[f],
                                    g = new t.Color,
                                    y = new t.Color;
                                g.setFromString(m.light), y.setFromString(m.dark), p.setFrame(d, this.getValue(m, "time", 0), g.r, g.g, g.b, g.a, y.r, y.g, y.b), this.readCurve(m, p, d), d++
                            }
                            i.push(p), o = Math.max(o, p.frames[(p.getFrameCount() - 1) * t.TwoColorTimeline.ENTRIES])
                        }
                    }
                }
            if (e.bones)
                for (var w in e.bones) {
                    var x = e.bones[w],
                        E = r.findBoneIndex(w);
                    if (-1 == E) throw new Error("Bone not found: " + w);
                    for (var u in x) {
                        var c = x[u];
                        if ("rotate" === u) {
                            ...
                            for (var d = 0, f = 0; f < c.length; f++) {
                                var m = c[f];
                                p.setFrame(d, this.getValue(m, "time", 0), this.getValue(m, "angle", 0)), this.readCurve(m, p, d), d++
                            }
                            i.push(p), o = Math.max(o, p.frames[(p.getFrameCount() - 1) * t.RotateTimeline.ENTRIES])
                        } else {
                            if ("translate" !== u && "scale" !== u && "shear" !== u) throw new Error("Invalid timeline type for a bone: " + u + " (" + w + ")");
                            var p = null,
                                M = 1,
                                T = 0;
                            "scale" === u ? (p = new t.ScaleTimeline(c.length), T = 1) : "shear" === u ? p = new t.ShearTimeline(c.length) : (p = new t.TranslateTimeline(c.length), M = a), p.boneIndex = E;
                            for (var d = 0, f = 0; f < c.length; f++) {
                                var m = c[f],
                                    A = this.getValue(m, "x", T),
                                    S = this.getValue(m, "y", T);
                                p.setFrame(d, this.getValue(m, "time", 0), A * M, S * M), this.readCurve(m, p, d), d++
                            }
                            i.push(p), o = Math.max(o, p.frames[(p.getFrameCount() - 1) * t.TranslateTimeline.ENTRIES])
                        }
                    }
                }
            if (e.ik)
                for (var b in e.ik) {
                    var R = e.ik[b],
                        ...
                        p = new t.IkConstraintTimeline(R.length);
                    p.ikConstraintIndex = r.ikConstraints.indexOf(I);
                    for (var d = 0, f = 0; f < R.length; f++) {
                        var m = R[f];
                        p.setFrame(d, this.getValue(m, "time", 0), this.getValue(m, "mix", 1), this.getValue(m, "softness", 0) * a, this.getValue(m, "bendPositive", !0) ? 1 : -1, this.getValue(m, "compress", !1), this.getValue(m, "stretch", !1)), this.readCurve(m, p, d), d++
                    }
                    i.push(p), o = Math.max(o, p.frames[(p.getFrameCount() - 1) * t.IkConstraintTimeline.ENTRIES])
                }
            if (e.transform)
                for (var b in e.transform) {
                    var R = e.transform[b],
                        I = r.findTransformConstraint(b),
                        p = new t.TransformConstraintTimeline(R.length);
                    p.transformConstraintIndex = r.transformConstraints.indexOf(I);
                    for (var d = 0, f = 0; f < R.length; f++) {
                        var m = R[f];
                        p.setFrame(d, this.getValue(m, "time", 0), this.getValue(m, "rotateMix", 1), this.getValue(m, "translateMix", 1), this.getValue(m, "scaleMix", 1), this.getValue(m, "shearMix", 1)), this.readCurve(m, p, d), d++
                    }
                    i.push(p), o = Math.max(o, p.frames[(p.getFrameCount() - 1) * t.TransformConstraintTimeline.ENTRIES])
                }
            if (e.path)
                for (var b in e.path) {
                    var R = e.path[b],
                        C = r.findPathConstraintIndex(b);
                    if (-1 == C) throw new Error("Path constraint not found: " + b);
                    var _ = r.pathConstraints[C];
                    for (var u in R) {
                        var c = R[u];
                        if ("position" === u || "spacing" === u) {
                            var p = null,
                                M = 1;
                            "spacing" === u ? (p = new t.PathConstraintSpacingTimeline(c.length), (_.spacingMode == t.SpacingMode.Length || _.spacingMode == t.SpacingMode.Fixed) && (M = a)) : (p = new t.PathConstraintPositionTimeline(c.length), _.positionMode == t.PositionMode.Fixed && (M = a)), p.pathConstraintIndex = C;
                            for (var d = 0, f = 0; f < c.length; f++) {
                                var m = c[f];
                                p.setFrame(d, this.getValue(m, "time", 0), this.getValue(m, u, 0) * M), this.readCurve(m, p, d), d++
                            }
                            i.push(p), o = Math.max(o, p.frames[(p.getFrameCount() - 1) * t.PathConstraintPositionTimeline.ENTRIES])
                        } else if ("mix" === u) {
                            var p = new t.PathConstraintMixTimeline(c.length);
                            p.pathConstraintIndex = C;
                            for (var d = 0, f = 0; f < c.length; f++) {
                                var m = c[f];
                                p.setFrame(d, this.getValue(m, "time", 0), this.getValue(m, "rotateMix", 1), this.getValue(m, "translateMix", 1)), this.readCurve(m, p, d), d++
                            }
                            i.push(p), o = Math.max(o, p.frames[(p.getFrameCount() - 1) * t.PathConstraintMixTimeline.ENTRIES])
                        }
                    }
                }
            if (e.deform)
                for (var P in e.deform) {
                    ...
                    for (var s in k) {
                        ...
                        for (var u in l) {
                            var c = l[u],
                                F = V.getAttachment(h, u);
                            if (null == F) throw new Error("Deform attachment not found: " + c.name);
                            var N = null != F.bones,
                                U = F.vertices,
                                D = N ? U.length / 3 * 2 : U.length,
                                p = new t.DeformTimeline(c.length);
                            p.slotIndex = h, p.attachment = F;
                            for (var d = 0, L = 0; L < c.length; L++) {
                                var m = c[L],
                                    Y = void 0,
                                    X = this.getValue(m, "vertices", null);
                                if (null == X) Y = N ? t.Utils.newFloatArray(D) : U;
                                else {
                                    Y = t.Utils.newFloatArray(D);
                                    var B = this.getValue(m, "offset", 0);
                                    if (t.Utils.arrayCopy(X, 0, Y, B, X.length), 1 != a)
                                        for (var f = B, O = f + X.length; O > f; f++) Y[f] *= a;
                                    if (!N)
                                        for (var f = 0; D > f; f++) Y[f] += U[f]
                                }
                                p.setFrame(d, this.getValue(m, "time", 0), Y), this.readCurve(m, p, d), d++
                            }
                            i.push(p), o = Math.max(o, p.frames[p.getFrameCount() - 1])
                        }
                    }
            ...
            if (null == W && (W = e.draworder), null != W) {
                for (var p = new t.DrawOrderTimeline(W.length), q = r.slots.length, d = 0, L = 0; L < W.length; L++) {
                    var H = W[L],
                        G = null,
                        j = this.getValue(H, "offsets", null);
                    if (null != j) {
                        G = t.Utils.newArray(q, -1);
                        for (var Z = t.Utils.newArray(q - j.length, 0), z = 0, Q = 0, f = 0; f < j.length; f++) {
                            var $ = j[f],
                                h = r.findSlotIndex($.slot);
                            if (-1 == h) throw new Error("Slot not found: " + $.slot);
                            for (; z != h;) Z[Q++] = z++;
                            G[z + $.offset] = z++
                        }
                        for (; q > z;) Z[Q++] = z++;
                        for (var f = q - 1; f >= 0; f--) - 1 == G[f] && (G[f] = Z[--Q])
                    }
                    p.setFrame(d++, this.getValue(H, "time", 0), G)
                }
                i.push(p), o = Math.max(o, p.frames[p.getFrameCount() - 1])
            }
            if (e.events) {
                for (var p = new t.EventTimeline(e.events.length), d = 0, f = 0; f < e.events.length; f++) {
                    var J = e.events[f],
                        K = r.findEvent(J.name);
                    if (null == K) throw new Error("Event not found: " + J.name);
                    var te = new t.Event(t.Utils.toSinglePrecision(this.getValue(J, "time", 0)), K);
                    te.intValue = this.getValue(J, "int", K.intValue), te.floatValue = this.getValue(J, "float", K.floatValue), te.stringValue = this.getValue(J, "string", K.stringValue), null != te.data.audioPath && (te.volume = this.getValue(J, "volume", 1), te.balance = this.getValue(J, "balance", 0)), p.setFrame(d++, te)
                }
                i.push(p), o = Math.max(o, p.frames[p.getFrameCount() - 1])
            }
    ...
    t.SkeletonJson = e, __reflect(e.prototype, "spine.SkeletonJson");
    var n = function() {
        function t(t, e, n, r, a) {
            this.mesh = t, this.skin = e, this.slotIndex = n, this.parent = r, this.inheritDeform = a
        }
    ...
    __reflect(n.prototype, "LinkedMesh")
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
    ...
    var n = function() {
        ...
        return n.prototype.setAttachment = function(t, e, n) {
            ...
            for (var e = 0; e < t.bones.length; e++) {
                for (var n = t.bones[e], r = !1, a = 0; a < this.bones.length; a++)
                    if (this.bones[a] == n) {
                        r = !0;
                        break
                    }
            ...
            for (var e = 0; e < t.constraints.length; e++) {
                for (var i = t.constraints[e], r = !1, a = 0; a < this.constraints.length; a++)
                    if (this.constraints[a] == i) {
                        r = !0;
                        break
                    }
            ...
            for (var n = 0; n < e.bones.length; n++) {
                for (var r = e.bones[n], a = !1, i = 0; i < this.bones.length; i++)
                    if (this.bones[i] == r) {
                        a = !0;
                        break
                    }
            ...
            for (var n = 0; n < e.constraints.length; n++) {
                for (var o = e.constraints[n], a = !1, i = 0; i < this.constraints.length; i++)
            ...
            for (var s = e.getAttachments(), n = 0; n < s.length; n++) {
                var l = s[n];
    ...
    t.Skin = n, __reflect(n.prototype, "spine.Skin")
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
        ...
        return e.prototype.update = function(t) {
            t *= this.timeScale;
            for (var e = this.tracks, n = 0, r = e.length; r > n; n++) {
                var a = e[n];
                if (null != a) {
            ...
            for (var r = this.events, a = this.tracks, i = !1, o = 0, s = a.length; s > o; o++) {
                var l = a[o];
                if (!(null == l || l.delay > 0)) {
                    i = !0;
                    ...
                    if (0 == o && 1 == u || h == t.MixBlend.add)
                        for (var m = 0; d > m; m++) {
                            t.Utils.webkit602BugfixHelper(u, h);
                            var v = f[m];
                            v instanceof t.AttachmentTimeline ? this.applyAttachmentTimeline(v, n, p, h, !0) : v.apply(n, c, p, r, u, h, t.MixDirection.mixIn)
                        } else {
                            var g = l.timelineMode,
                                y = 0 == l.timelinesRotation.length;
                            y && t.Utils.setArraySize(l.timelinesRotation, d << 1, null);
                            for (var w = l.timelinesRotation, m = 0; d > m; m++) {
                                var x = f[m],
                                    E = g[m] == e.SUBSEQUENT ? h : t.MixBlend.setup;
                                x instanceof t.RotateTimeline ? this.applyRotateTimeline(x, n, p, u, E, w, m << 1, y) : x instanceof t.AttachmentTimeline ? this.applyAttachmentTimeline(x, n, p, h, !0) : (t.Utils.webkit602BugfixHelper(u, h), x.apply(n, c, p, r, u, E, t.MixDirection.mixIn))
                            }
                        }
                    this.queueEvents(l, p), r.length = 0, l.nextAnimationLast = p, l.nextTrackLast = l.trackTime
                }
            }
            for (var M = this.unkeyedState + e.SETUP, T = n.slots, A = 0, S = n.slots.length; S > A; A++) {
                var b = T[A];
                if (b.attachmentState == M) {
                    var R = b.data.attachmentName;
                    b.attachment = null == R ? null : n.getAttachment(b.data.index, R)
                }
            }
            ...
            var o = 0;
            0 == n.mixDuration ? (o = 1, a == t.MixBlend.first && (a = t.MixBlend.setup)) : (o = n.mixTime / n.mixDuration, o > 1 && (o = 1), a != t.MixBlend.first && (a = i.mixBlend));
            var s = o < i.eventThreshold ? this.events : null,
                l = o < i.attachmentThreshold,
                h = o < i.drawOrderThreshold,
                u = i.animationLast,
                c = i.getAnimationTime(),
                p = i.animation.timelines.length,
                d = i.animation.timelines,
                f = i.alpha * n.interruptAlpha,
                m = f * (1 - o);
            if (a == t.MixBlend.add)
                for (var v = 0; p > v; v++) d[v].apply(r, u, c, s, m, a, t.MixDirection.mixOut);
            else {
                var g = i.timelineMode,
                    y = i.timelineHoldMix,
                    w = 0 == i.timelinesRotation.length;
                w && t.Utils.setArraySize(i.timelinesRotation, p << 1, null);
                var x = i.timelinesRotation;
                i.totalAlpha = 0;
                for (var v = 0; p > v; v++) {
                    var E = d[v],
                    ...
                    switch (g[v]) {
                        ...
                        default:
                            T = t.MixBlend.setup;
                            var S = y[v];
                            A = f * Math.max(0, 1 - S.mixTime / S.mixDuration)
                    }
                    i.totalAlpha += A, E instanceof t.RotateTimeline ? this.applyRotateTimeline(E, r, c, A, T, x, v << 1, w) : E instanceof t.AttachmentTimeline ? this.applyAttachmentTimeline(E, r, c, T, l) : (t.Utils.webkit602BugfixHelper(A, a), h && E instanceof t.DrawOrderTimeline && T == t.MixBlend.setup && (M = t.MixDirection.mixIn), E.apply(r, u, c, s, A, T, M))
                }
            }
            return n.mixDuration > 0 && this.queueEvents(i, c), this.events.length = 0, i.nextAnimationLast = c, i.nextTrackLast = i.trackTime, o
        }, e.prototype.applyAttachmentTimeline = function(n, r, a, i, o) {
            var s = r.slots[n.slotIndex];
            if (s.bone.active) {
                var l = n.frames;
                if (a < l[0])(i == t.MixBlend.setup || i == t.MixBlend.first) && this.setAttachment(r, s, s.data.attachmentName, o);
                else {
                    var h;
                    h = a >= l[l.length - 1] ? l.length - 1 : t.Animation.binarySearch(l, a) - 1, this.setAttachment(r, s, n.attachmentNames[h], o)
                }
                s.attachmentState <= this.unkeyedState && (s.attachmentState = this.unkeyedState + e.SETUP)
            }
        }, e.prototype.setAttachment = function(t, n, r, a) {
            n.attachment = null == r ? null : t.getAttachment(n.data.index, r), a && (n.attachmentState = this.unkeyedState + e.CURRENT)
        }, e.prototype.applyRotateTimeline = function(e, n, r, a, i, o, s, l) {
            if (l && (o[s] = 0), 1 == a) return void e.apply(n, 0, r, null, 1, i, t.MixDirection.mixIn);
            var h = e,
                u = h.frames,
            ...
            if (c.active) {
                ...
                if (r < u[0]) switch (i) {
                    ...
                    } else if (p = i == t.MixBlend.setup ? c.data.rotation : c.rotation, r >= u[u.length - t.RotateTimeline.ENTRIES]) d = c.data.rotation + u[u.length + t.RotateTimeline.PREV_ROTATION];
                    else {
                        var f = t.Animation.binarySearch(u, r, t.RotateTimeline.ENTRIES),
                            m = u[f + t.RotateTimeline.PREV_ROTATION],
                            v = u[f],
                            g = h.getCurvePercent((f >> 1) - 1, 1 - (r - v) / (u[f + t.RotateTimeline.PREV_TIME] - v));
                        d = u[f + t.RotateTimeline.ROTATION] - m, d -= 360 * (16384 - (16384.499999999996 - d / 360 | 0)), d = m + d * g + c.data.rotation, d -= 360 * (16384 - (16384.499999999996 - d / 360 | 0))
                    }
                var y = 0,
                    w = d - p;
                if (w -= 360 * (16384 - (16384.499999999996 - w / 360 | 0)), 0 == w) y = o[s];
                else {
                    var x = 0,
                        E = 0;
                    l ? (x = 0, E = w) : (x = o[s], E = o[s + 1]);
                    var M = w > 0,
                        T = x >= 0;
                    t.MathUtils.signum(E) != t.MathUtils.signum(w) && Math.abs(E) <= 90 && (Math.abs(x) > 180 && (x += 360 * t.MathUtils.signum(x)), T = M), y = w + x - x % 360, T != M && (y += 360 * t.MathUtils.signum(x)), o[s] = y
                }
                o[s + 1] = w, p += y * a, c.rotation = p - 360 * (16384 - (16384.499999999996 - p / 360 | 0))
            }
        }, e.prototype.queueEvents = function(t, e) {
            for (var n = t.animationStart, r = t.animationEnd, a = r - n, i = t.trackLast % a, o = this.events, s = 0, l = o.length; l > s; s++) {
                var h = o[s];
                if (h.time < i) break;
                h.time > r || this.queue.event(t, h)
            }
            var u = !1;
            for (u = t.loop ? 0 == a || i > t.trackTime % a : e >= r && t.animationLast < r, u && this.queue.complete(t); l > s; s++) {
                var c = o[s];
                c.time < n || this.queue.event(t, o[s])
            }
        }, e.prototype.clearTracks = function() {
            var t = this.queue.drainDisabled;
            this.queue.drainDisabled = !0;
            for (var e = 0, n = this.tracks.length; n > e; e++) this.clearTrack(e);
            ...
            var i = this.trackEntry(t, e, n, a);
            if (null == a) this.setCurrent(t, i, !0), this.queue.drain();
            else if (a.next = i, 0 >= r) {
                var o = a.animationEnd - a.animationStart;
                0 != o ? (r += a.loop ? o * (1 + (a.trackTime / o | 0)) : Math.max(o, a.trackTime), r -= this.data.getMix(a.animation, e)) : r = a.trackTime
            }
            return i.delay = r, i
            ...
            this.queue.drainDisabled = !0;
            for (var n = 0, r = this.tracks.length; r > n; n++) {
                var a = this.tracks[n];
            ...
            for (var e = 0, n = this.tracks.length; n > e; e++) {
                var r = this.tracks[e];
                if (null != r) {
                    for (; null != r.mixingFrom;) r = r.mixingFrom;
                    do(null == r.mixingFrom || r.mixBlend != t.MixBlend.add) && this.computeHold(r), r = r.mixingTo; while (null != r)
                }
            }
            ...
            var s = t.Utils.setArraySize(n.timelineHoldMix, i),
                l = this.propertyIDs;
            if (null != r && r.holdPrevious)
                for (var h = 0; i > h; h++) o[h] = l.add(a[h].getPropertyId()) ? e.HOLD_FIRST : e.HOLD_SUBSEQUENT;
            else t: for (var h = 0; i > h; h++) {
                var u = a[h],
                    c = u.getPropertyId();
                if (l.add(c))
                    if (null == r || u instanceof t.AttachmentTimeline || u instanceof t.DrawOrderTimeline || u instanceof t.EventTimeline || !r.animation.hasTimeline(c)) o[h] = e.FIRST;
                    else {
                        for (var p = r.mixingTo; null != p; p = p.mixingTo)
    ...
    t.TrackEntry = n, __reflect(n.prototype, "spine.TrackEntry");
    var r = function() {
        function t(t) {
    ...
    t.EventQueue = r, __reflect(r.prototype, "spine.EventQueue");
    var a;
    ! function(t) {
    ...
    t.AnimationStateAdapter = i, __reflect(i.prototype, "spine.AnimationStateAdapter", ["spine.AnimationStateListener"])
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
        function e(e, n, r) {
            if (this.color = new t.Color(1, 1, 1, 1), 0 > e) throw new Error("index must be >= 0.");
...
! function(t) {
    var e = function() {
        ...
        return e.prototype.isActive = function() {
            ...
            this.updateWorldTransformWith(this.x, this.y, this.rotation, this.scaleX, this.scaleY, this.shearX, this.shearY)
        }, e.prototype.updateWorldTransformWith = function(e, n, r, a, i, o, s) {
            this.ax = e, this.ay = n, this.arotation = r, this.ascaleX = a, this.ascaleY = i, this.ashearX = o, this.ashearY = s, this.appliedValid = !0;
            var l = this.parent;
            if (null == l) {
                var h = this.skeleton,
                    u = r + 90 + s,
                    c = h.scaleX,
                    p = h.scaleY;
                return this.a = t.MathUtils.cosDeg(r + o) * a * c, this.b = t.MathUtils.cosDeg(u) * i * c, this.c = t.MathUtils.sinDeg(r + o) * a * p, this.d = t.MathUtils.sinDeg(u) * i * p, this.worldX = e * c + h.x, void(this.worldY = n * p + h.y)
            }
            var d = l.a,
                f = l.b,
                m = l.c,
                v = l.d;
            switch (this.worldX = d * e + f * n + l.worldX, this.worldY = m * e + v * n + l.worldY, this.data.transformMode) {
                case t.TransformMode.Normal:
                    var u = r + 90 + s,
                        g = t.MathUtils.cosDeg(r + o) * a,
                        y = t.MathUtils.cosDeg(u) * i,
                        w = t.MathUtils.sinDeg(r + o) * a,
                        x = t.MathUtils.sinDeg(u) * i;
                    return this.a = d * g + f * w, this.b = d * y + f * x, this.c = m * g + v * w, void(this.d = m * y + v * x);
                case t.TransformMode.OnlyTranslation:
                    var u = r + 90 + s;
                    this.a = t.MathUtils.cosDeg(r + o) * a, this.b = t.MathUtils.cosDeg(u) * i, this.c = t.MathUtils.sinDeg(r + o) * a, this.d = t.MathUtils.sinDeg(u) * i;
                    break;
                case t.TransformMode.NoRotationOrReflection:
                    var E = d * d + m * m,
                        M = 0;
                    E > 1e-4 ? (E = Math.abs(d * v - f * m) / E, d /= this.skeleton.scaleX, m /= this.skeleton.scaleY, f = m * E, v = d * E, M = Math.atan2(m, d) * t.MathUtils.radDeg) : (d = 0, m = 0, M = 90 - Math.atan2(v, f) * t.MathUtils.radDeg);
                    var T = r + o - M,
                        A = r + s - M + 90,
                        g = t.MathUtils.cosDeg(T) * a,
                        y = t.MathUtils.cosDeg(A) * i,
                        w = t.MathUtils.sinDeg(T) * a,
                        x = t.MathUtils.sinDeg(A) * i;
                    this.a = d * g - f * w, this.b = d * y - f * x, this.c = m * g + v * w, this.d = m * y + v * x;
                    break;
                case t.TransformMode.NoScale:
                case t.TransformMode.NoScaleOrReflection:
                    var S = t.MathUtils.cosDeg(r),
                        b = t.MathUtils.sinDeg(r),
                        R = (d * S + f * b) / this.skeleton.scaleX,
                        I = (m * S + v * b) / this.skeleton.scaleY,
                        E = Math.sqrt(R * R + I * I);
                    E > 1e-5 && (E = 1 / E), R *= E, I *= E, E = Math.sqrt(R * R + I * I), this.data.transformMode == t.TransformMode.NoScale && 0 > d * v - f * m != (this.skeleton.scaleX < 0 != this.skeleton.scaleY < 0) && (E = -E);
                    var C = Math.PI / 2 + Math.atan2(I, R),
                        _ = Math.cos(C) * E,
                        P = Math.sin(C) * E,
                        g = t.MathUtils.cosDeg(o) * a,
                        y = t.MathUtils.cosDeg(90 + s) * i,
                        w = t.MathUtils.sinDeg(o) * a,
                        x = t.MathUtils.sinDeg(90 + s) * i;
                    this.a = R * g + _ * w, this.b = R * y + _ * x, this.c = I * g + P * w, this.d = I * y + P * x
            }
            ...
            this.ax = s * i * o - l * r * o, this.ay = l * n * o - s * a * o;
            var h = o * i,
                u = o * n,
                c = o * r,
                p = o * a,
            ...
            } else this.ascaleX = 0, this.ascaleY = Math.sqrt(f * f + v * v), this.ashearY = 0, this.arotation = 90 - Math.atan2(v, f) * t.MathUtils.radDeg
            ...
            var e = this.a,
                ...
                o = t.x - this.worldX,
                s = t.y - this.worldY;
            return t.x = o * a * i - s * n * i, t.y = s * e * i - o * r * i, t
            ...
            return Math.atan2(this.a * n - this.c * r, this.d * r - this.b * n) * t.MathUtils.radDeg + this.rotation - this.shearX
        }, e.prototype.localToWorldRotation = function(e) {
            e -= this.rotation - this.shearX;
            var n = t.MathUtils.sinDeg(e),
                r = t.MathUtils.cosDeg(e);
            return Math.atan2(r * this.c + n * this.d, r * this.a + n * this.b) * t.MathUtils.radDeg
            ...
            this.a = o * n - s * a, this.b = o * r - s * i, this.c = s * n + o * a, this.d = s * r + o * i, this.appliedValid = !1
        }, e
    }();
...
! function(t) {
    var e = function() {
        ...
        return e.prototype.load = function(e, i) {
            ...
            for (var o = new n(e), s = new Array(4), l = null;;) {
                var h = o.readLine();
                if (null == h) break;
                if (h = h.trim(), 0 == h.length) l = null;
                else if (l) {
                    var u = new a;
                    u.name = h, u.page = l;
                    var c = o.readValue();
                    "true" == c.toLocaleLowerCase() ? u.degrees = 90 : "false" == c.toLocaleLowerCase() ? u.degrees = 0 : u.degrees = parseFloat(c), u.rotate = 90 == u.degrees, o.readTuple(s);
                    var p = parseInt(s[0]),
                        d = parseInt(s[1]);
                    o.readTuple(s);
                    var f = parseInt(s[0]),
                        m = parseInt(s[1]);
                    u.u = p / l.width, u.v = d / l.height, u.rotate ? (u.u2 = (p + m) / l.width, u.v2 = (d + f) / l.height) : (u.u2 = (p + f) / l.width, u.v2 = (d + m) / l.height), u.x = p, u.y = d, u.width = Math.abs(f), u.height = Math.abs(m), 4 == o.readTuple(s) && 4 == o.readTuple(s) && o.readTuple(s), u.originalWidth = parseInt(s[0]), u.originalHeight = parseInt(s[1]), o.readTuple(s), u.offsetX = parseInt(s[0]), u.offsetY = parseInt(s[1]), u.index = parseInt(o.readValue()), u.texture = l.texture, this.regions.push(u)
                } else {
                    l = new r, l.name = h, 2 == o.readTuple(s) && (l.width = parseInt(s[0]), l.height = parseInt(s[1]), o.readTuple(s)), o.readTuple(s), l.minFilter = t.Texture.filterFromString(s[0]), l.magFilter = t.Texture.filterFromString(s[1]);
                    var v = o.readValue();
                    l.uWrap = t.TextureWrap.ClampToEdge, l.vWrap = t.TextureWrap.ClampToEdge, "x" == v ? l.uWrap = t.TextureWrap.Repeat : "y" == v ? l.vWrap = t.TextureWrap.Repeat : "xy" == v && (l.uWrap = l.vWrap = t.TextureWrap.Repeat), l.texture = i(h), l.texture.setFilters(l.minFilter, l.magFilter), l.texture.setWraps(l.uWrap, l.vWrap), l.width = l.texture.getImage().width, l.height = l.texture.getImage().height, this.pages.push(l)
                }
            }
    ...
    __reflect(n.prototype, "TextureAtlasReader");
    var r = function() {
        function t() {}
        return t
    }();
    t.TextureAtlasPage = r, __reflect(r.prototype, "spine.TextureAtlasPage");
    var a = function(t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
    ...
    t.TextureAtlasRegion = a, __reflect(a.prototype, "spine.TextureAtlasRegion")
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
        ...
        return e.prototype.isActive = function() {
            ...
            for (var e = this.rotateMix, n = this.translateMix, r = this.scaleMix, a = this.shearMix, i = this.target, o = i.a, s = i.b, l = i.c, h = i.d, u = o * h - s * l > 0 ? t.MathUtils.degRad : -t.MathUtils.degRad, c = this.data.offsetRotation * u, p = this.data.offsetShearY * u, d = this.bones, f = 0, m = d.length; m > f; f++) {
                var v = d[f],
                    g = !1;
                if (0 != e) {
                    var y = v.a,
                        ...
                        x = v.c,
                        E = v.d,
                        M = Math.atan2(l, o) - Math.atan2(x, y) + c;
                    M > t.MathUtils.PI ? M -= t.MathUtils.PI2 : M < -t.MathUtils.PI && (M += t.MathUtils.PI2), M *= e;
                    var T = Math.cos(M),
                        A = Math.sin(M);
                    v.a = T * y - A * x, v.b = T * w - A * E, v.c = A * y + T * x, v.d = A * w + T * E, g = !0
                }
                if (0 != n) {
                    var S = this.temp;
                    i.localToWorld(S.set(this.data.offsetX, this.data.offsetY)), v.worldX += (S.x - v.worldX) * n, v.worldY += (S.y - v.worldY) * n, g = !0
                }
                if (r > 0) {
                    var b = Math.sqrt(v.a * v.a + v.c * v.c),
                        R = Math.sqrt(o * o + l * l);
                    b > 1e-5 && (b = (b + (R - b + this.data.offsetScaleX) * r) / b), v.a *= b, v.c *= b, b = Math.sqrt(v.b * v.b + v.d * v.d), R = Math.sqrt(s * s + h * h), b > 1e-5 && (b = (b + (R - b + this.data.offsetScaleY) * r) / b), v.b *= b, v.d *= b, g = !0
                }
                if (a > 0) {
                    var w = v.b,
                        E = v.d,
                        I = Math.atan2(E, w),
                        M = Math.atan2(h, s) - Math.atan2(l, o) - (I - Math.atan2(v.c, v.a));
                    M > t.MathUtils.PI ? M -= t.MathUtils.PI2 : M < -t.MathUtils.PI && (M += t.MathUtils.PI2), M = I + (M + p) * a;
                    var b = Math.sqrt(w * w + E * E);
                    v.b = Math.cos(M) * b, v.d = Math.sin(M) * b, g = !0
                }
                g && (v.appliedValid = !1)
            }
            ...
            for (var e = this.rotateMix, n = this.translateMix, r = this.scaleMix, a = this.shearMix, i = this.target, o = i.a, s = i.b, l = i.c, h = i.d, u = o * h - s * l > 0 ? t.MathUtils.degRad : -t.MathUtils.degRad, c = this.data.offsetRotation * u, p = this.data.offsetShearY * u, d = this.bones, f = 0, m = d.length; m > f; f++) {
                ...
                if (0 != n) {
                    var S = this.temp;
                    i.localToWorld(S.set(this.data.offsetX, this.data.offsetY)), v.worldX += S.x * n, v.worldY += S.y * n, g = !0
                }
                if (r > 0) {
                    var b = (Math.sqrt(o * o + l * l) - 1 + this.data.offsetScaleX) * r + 1;
                    v.a *= b, v.c *= b, b = (Math.sqrt(s * s + h * h) - 1 + this.data.offsetScaleY) * r + 1, v.b *= b, v.d *= b, g = !0
                }
                if (a > 0) {
                    var M = Math.atan2(h, s) - Math.atan2(l, o);
                    M > t.MathUtils.PI ? M -= t.MathUtils.PI2 : M < -t.MathUtils.PI && (M += t.MathUtils.PI2);
                    var w = v.b,
                        E = v.d;
                    M = Math.atan2(E, w) + (M - t.MathUtils.PI / 2 + p) * a;
                    var b = Math.sqrt(w * w + E * E);
                    v.b = Math.cos(M) * b, v.d = Math.sin(M) * b, g = !0
                }
                g && (v.appliedValid = !1)
            ...
            for (var i = this.bones, o = 0, s = i.length; s > o; o++) {
                var l = i[o];
                ...
                var d = l.ascaleX,
                    f = l.ascaleY;
                0 != n && (d > 1e-5 && (d = (d + (a.ascaleX - d + this.data.offsetScaleX) * n) / d), f > 1e-5 && (f = (f + (a.ascaleY - f + this.data.offsetScaleY) * n) / f));
                var m = l.ashearY;
                if (0 != r) {
                    var u = a.ashearY - m + this.data.offsetShearY;
            ...
            for (var i = this.bones, o = 0, s = i.length; s > o; o++) {
                ...
                var p = l.ascaleX,
                    d = l.ascaleY;
                0 != n && (p > 1e-5 && (p *= (a.ascaleX - 1 + this.data.offsetScaleX) * n + 1), d > 1e-5 && (d *= (a.ascaleY - 1 + this.data.offsetScaleY) * n + 1));
                var f = l.ashearY;
                0 != r && (f += (a.ashearY + this.data.offsetShearY) * r), l.updateWorldTransformWith(u, c, h, p, d, l.ashearX, f)
            }
        }, e
    }();
...
! function(t) {
    var e = function() {
        ...
        return e.prototype.downloadText = function(t, e, n) {
            var r = new XMLHttpRequest;
            r.overrideMimeType("text/html"), this.rawDataUris[t] && (t = this.rawDataUris[t]), r.open("GET", t, !0), r.onload = function() {
            ...
            var r = new XMLHttpRequest;
            this.rawDataUris[t] && (t = this.rawDataUris[t]), r.open("GET", t, !0), r.responseType = "arraybuffer", r.onload = function() {
            ...
            void 0 === e && (e = null), void 0 === n && (n = null), t = this.pathPrefix + t, this.toLoad++, this.downloadBinary(t, function(n) {
                r.assets[t] = n, e && e(t, n), r.toLoad--, r.loaded++
            }, function(e, a) {
                r.errors[t] = "Couldn't load binary " + t + ": status " + status + ", " + a, n && n(t, "Couldn't load binary " + t + ": status " + status + ", " + a), r.toLoad--, r.loaded++
            })
            ...
            void 0 === e && (e = null), void 0 === n && (n = null), t = this.pathPrefix + t, this.toLoad++, this.downloadText(t, function(n) {
                ...
                r.errors[t] = "Couldn't load text " + t + ": status " + status + ", " + a, n && n(t, "Couldn't load text " + t + ": status " + status + ", " + a), r.toLoad--, r.loaded++
            })
        }, e.prototype.loadTexture = function(t, e, n) {
            var r = this;
            void 0 === e && (e = null), void 0 === n && (n = null), t = this.pathPrefix + t;
            var a = t;
            this.toLoad++;
            var i = new Image;
            i.crossOrigin = "anonymous", i.onload = function(n) {
                var o = r.textureLoader(i);
                r.assets[a] = o, r.toLoad--, r.loaded++, e && e(t, i)
            }, i.onerror = function(e) {
                r.errors[t] = "Couldn't load image " + t, r.toLoad--, r.loaded++, n && n(t, "Couldn't load image " + t)
            }, this.rawDataUris[t] && (t = this.rawDataUris[t]), i.src = t
        }, e.prototype.loadTextureAtlas = function(e, n, r) {
            var a = this;
            void 0 === n && (n = null), void 0 === r && (r = null);
            var i = e.lastIndexOf("/") >= 0 ? e.substring(0, e.lastIndexOf("/")) : "";
            e = this.pathPrefix + e, this.toLoad++, this.downloadText(e, function(o) {
                var s = {
                        count: 0
                    },
                    l = new Array;
                try {
                    new t.TextureAtlas(o, function(e) {
                        l.push("" == i ? e : i + "/" + e);
                    ...
                    var u = h;
                    return a.errors[e] = "Couldn't load texture atlas " + e + ": " + u.message, r && r(e, "Couldn't load texture atlas " + e + ": " + u.message), a.toLoad--, void a.loaded++
                }
                for (var c = function(h) {
                        var u = !1;
                        a.loadTexture(h, function(h, c) {
                            if (s.count++, s.count == l.length)
                                if (u) a.errors[e] = "Couldn't load texture atlas page " + h + "} of atlas " + e, r && r(e, "Couldn't load texture atlas page " + h + " of atlas " + e), a.toLoad--, a.loaded++;
                                else try {
                                    var p = new t.TextureAtlas(o, function(t) {
                                        return a.get("" == i ? t : i + "/" + t)
                                    });
                                    a.assets[e] = p, n && n(e, p), a.toLoad--, a.loaded++
                                } catch (d) {
                                    var f = d;
                                    a.errors[e] = "Couldn't load texture atlas " + e + ": " + f.message, r && r(e, "Couldn't load texture atlas " + e + ": " + f.message), a.toLoad--, a.loaded++
                                }
                        }, function(t, n) {
                            u = !0, s.count++, s.count == l.length && (a.errors[e] = "Couldn't load texture atlas page " + t + "} of atlas " + e, r && r(e, "Couldn't load texture atlas page " + t + " of atlas " + e), a.toLoad--, a.loaded++)
                        })
                    }, p = 0, d = l; p < d.length; p++) {
                    var f = d[p];
                    c(f)
                }
            }, function(t, n) {
                a.errors[e] = "Couldn't load texture atlas " + e + ": status " + status + ", " + n, r && r(e, "Couldn't load texture atlas " + e + ": status " + status + ", " + n), a.toLoad--, a.loaded++
            })
    ...
    t.AssetManager = e, __reflect(e.prototype, "spine.AssetManager", ["spine.Disposable"])
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(n, e), n.prototype.updateUVs = function() {
            ...
            if (this.region instanceof t.TextureAtlasRegion) {
                ...
                switch (l.degrees) {
                    case 90:
                        a -= (l.originalHeight - l.offsetY - l.height) / h, i -= (l.originalWidth - l.offsetX - l.width) / u, o = l.originalHeight / h, s = l.originalWidth / u;
                        for (var c = 0; r > c; c += 2) n[c] = a + e[c + 1] * o, n[c + 1] = i + (1 - e[c]) * s;
                        return;
                    case 180:
                        a -= (l.originalWidth - l.offsetX - l.width) / h, i -= l.offsetY / u, o = l.originalWidth / h, s = l.originalHeight / u;
                        for (var c = 0; r > c; c += 2) n[c] = a + (1 - e[c]) * o, n[c + 1] = i + (1 - e[c + 1]) * s;
                        return;
                    case 270:
                        a -= l.offsetY / h, i -= l.offsetX / u, o = l.originalHeight / h, s = l.originalWidth / u;
                        for (var c = 0; r > c; c += 2) n[c] = a + (1 - e[c + 1]) * o, n[c + 1] = i + e[c] * s;
                        return
                }
                a -= l.offsetX / h, i -= (l.originalHeight - l.offsetY - l.height) / u, o = l.originalWidth / h, s = l.originalHeight / u
            } else null == this.region ? (a = i = 0, o = s = 1) : (o = this.region.u2 - a, s = this.region.v2 - i);
            for (var c = 0; r > c; c += 2) n[c] = a + e[c] * o, n[c + 1] = i + e[c + 1] * s
    ...
    var e = function(e) {
        ...
        return __extends(n, e), n.prototype.computeWorldPosition = function(t, e) {
            ...
            var n = t.MathUtils.cosDeg(this.rotation),
                ...
                a = n * e.a + r * e.b,
                i = n * e.c + r * e.d;
            return Math.atan2(i, a) * t.MathUtils.radDeg
        }, n.prototype.copy = function() {
            var t = new n(this.name);
    ...
    var e = function(e) {
        ...
        return __extends(n, e), n.prototype.updateOffset = function() {
            var t = this.width / this.region.originalWidth * this.scaleX,
                ...
                i = r + this.region.width * t,
                o = a + this.region.height * e,
                ...
                g = o * h,
                y = this.offset;
            y[n.OX1] = u - d, y[n.OY1] = p + c, y[n.OX2] = u - g, y[n.OY2] = v + c, y[n.OX3] = f - g, y[n.OY3] = v + m, y[n.OX4] = f - d, y[n.OY4] = p + m
            ...
            var i = this.offset,
                ...
                p = 0,
                d = 0;
            p = i[n.OX1], d = i[n.OY1], e[r] = p * l + d * h + o, e[r + 1] = p * u + d * c + s, r += a, p = i[n.OX2], d = i[n.OY2], e[r] = p * l + d * h + o, e[r + 1] = p * u + d * c + s, r += a, p = i[n.OX3], d = i[n.OY3], e[r] = p * l + d * h + o, e[r + 1] = p * u + d * c + s, r += a, p = i[n.OX4], d = i[n.OY4], e[r] = p * l + d * h + o, e[r + 1] = p * u + d * c + s
        }, n.prototype.copy = function() {
            var e = new n(this.name);
...
! function(t) {
    var e = function() {
        ...
        return e.prototype.begin = function(t) {}, e.prototype.transform = function(e, n, r, a) {
    ...
    t.JitterEffect = e, __reflect(e.prototype, "spine.JitterEffect", ["spine.VertexEffect"])
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
    ...
    t.SwirlEffect = e, __reflect(e.prototype, "spine.SwirlEffect", ["spine.VertexEffect"])
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
...
! function(t) {
    var e = function(t) {
        function e() {
            ...
            return e.skeletonName = "", e.clipName = "", e
        }
        return __extends(e, t), e.START = "start", e.COMPLETE = "complete", e.EVENT = "frameEvent", e.INTERRUPT = "frameInterrupt", e.END = "frameEnd", e
    }(egret.Event);
    t.MovieEvent = e, __reflect(e.prototype, "spine.MovieEvent");
    var n = function(n) {
        function r(r) {
            var a = n.call(this) || this;
            a.lastTime = 0, a.renderer = new t.SkeletonRenderer(r), a.state = a.renderer.state, a.stateData = a.renderer.stateData, a.skeleton = a.renderer.skeleton, a.skeletonData = a.renderer.skeletonData, a.addChild(a.renderer), a.addEventListener(egret.Event.ADDED_TO_STAGE, a.onAddedToStage, a);
            var i = a;
            return a.state.addListener({
                event: function(t, n) {
                    i.sendEvent(e.EVENT, t, n)
                },
                complete: function(t) {
                    i.sendEvent(e.COMPLETE, t)
                },
                start: function(t) {
                    i.sendEvent(e.START, t)
                },
                interrupt: function(t) {
                    i.sendEvent(e.INTERRUPT, t)
                },
                end: function(t) {
                    i.sendEvent(e.END, t)
                },
        ...
        return __extends(r, n), r.prototype.sendEvent = function(t, n, r) {
            if (void 0 === r && (r = null), this.hasEventListener(t)) {
                var a = egret.Event.create(e, t);
                r && (a.eventData = r), a.trackIndex = n.trackIndex, a.clipName = n.animation.name, a.skeletonName = this.skeletonData.name, this.dispatchEvent(a)
            }
            ...
            return void 0 === e && (e = 0), void 0 === n && (n = 0), this.start(n).add(t, e)
            ...
            this.lastTime = Date.now() / 1e3, this.addEventListener(egret.Event.ENTER_FRAME, this.onEnterFrame, this), this.addEventListener(egret.Event.REMOVED_FROM_STAGE, this.onRemovedFromStage, this)
            ...
            var t = Date.now() / 1e3;
            this.renderer.update(t - this.lastTime), this.lastTime = t
        }, r
    }(egret.DisplayObjectContainer);
    t.SkeletonAnimation = n, __reflect(n.prototype, "spine.SkeletonAnimation")
}(spine || (spine = {}));
var spine;
! function(t) {
    function e(e, n) {
        var r = new t.SkeletonJson(new t.AtlasAttachmentLoader(n));
        return r.readSkeletonData(e)
    }

    function n(e, n) {
        return new t.TextureAtlas(e, function(t) {
            return new r(n[t].bitmapData)
        })
    }
    var r = function(t) {
        function e(e) {
            var n = t.call(this, e) || this,
                r = new egret.Texture;
            return r.bitmapData = e, n.spriteSheet = new egret.SpriteSheet(r), n
        }
        return __extends(e, t), e.prototype.setFilters = function(t, e) {}, e.prototype.setWraps = function(t, e) {}, e.prototype.dispose = function() {}, e
    }(t.Texture);
    __reflect(r.prototype, "AdapterTexture"), t.createSkeletonData = e, t.createTextureAtlas = n;
    var a = function(e) {
        function n(r) {
            var a = e.call(this) || this;
            a.slotRenderers = [], a.colored = !1, a.skeletonData = r, a.stateData = new t.AnimationStateData(r), a.state = new t.AnimationState(a.stateData), a.skeleton = new t.Skeleton(r), a.skeleton.updateWorldTransform(), a.touchEnabled = !0, a.scaleY = -1;
            for (var o = 0, s = a.skeleton.slots; o < s.length; o++) {
                var l = s[o],
                    h = new i;
                h.name = l.data.name, a.slotRenderers.push(h), a.addChild(h), h.renderSlot(l, a.skeleton, a.colored), a.colored = h.colored
            }
            return n.clipper.clipEnd(), a
        }
        return __extends(n, e), n.prototype.findSlotRenderer = function(t) {
            return this.getChildByName(t)
        }, n.prototype.update = function(t) {
            this.state.update(t), this.state.apply(this.skeleton), this.skeleton.updateWorldTransform();
            for (var e = this.skeleton.drawOrder, r = this.skeleton.slots, a = 0; a < e.length; a++) {
                var i = e[a].data.index;
                this.setChildIndex(this.slotRenderers[i], a)
            }
            for (var a = 0; a < r.length; a++) {
                var o = this.slotRenderers[a];
                o.renderSlot(r[a], this.skeleton, this.colored), this.colored = o.colored
            }
            n.clipper.clipEnd()
        }, n.vertices = t.Utils.newFloatArray(8192), n.QUAD_TRIANGLES = [0, 1, 2, 2, 3, 0], n.VERTEX_SIZE = 8, n.clipper = new t.SkeletonClipping, n
    }(egret.DisplayObjectContainer);
    t.SkeletonRenderer = a, __reflect(a.prototype, "spine.SkeletonRenderer");
    var i = function(e) {
        function n() {
            var n = e.call(this) || this;
            return n.colored = !1, n.tempColor = new t.Color, n.currentMesh = new egret.Mesh, n.addChild(n.currentMesh), n
        }
        return __extends(n, e), n.prototype.getRegionTexture = function(t) {
            var e = t.texture.spriteSheet;
            return e.$texture
        }, n.prototype.renderSlot = function(e, n, r) {
            var i = (e.bone, e.getAttachment()),
                o = null,
                s = null,
                l = a.clipper,
                h = 0;
            e.data.blendMode == t.BlendMode.Additive ? this.blendMode = egret.BlendMode.ADD : this.blendMode = egret.BlendMode.NORMAL;
            var u = a.vertices,
                c = null,
                p = (this.currentMesh ? this.currentMesh.name : "", new t.Color),
                d = l.isClipping() ? 2 : a.VERTEX_SIZE;
            i ? i.name : "";
            if (i instanceof t.RegionAttachment) {
                this.visible = !0;
                var f = i;
                u = this.computeRegionVertices(e, f, !1), c = a.QUAD_TRIANGLES, s = f.region, p = i.color, h = 4 * d, o = this.getRegionTexture(i.region)
            } else if (i instanceof t.MeshAttachment) {
                this.visible = !0;
                var m = i;
                u = this.computeMeshVertices(e, m, !1), c = m.triangles, s = m.region, p = i.color, h = (m.worldVerticesLength >> 1) * d, o = this.getRegionTexture(i.region)
            } else this.visible = !1;
            if (null != o) {
                var v = e.bone.skeleton,
                    g = v.color,
                    y = e.color,
                    w = g.a * y.a * p.a,
                    x = this.tempColor;
                x.set(g.r * y.r * p.r, g.g * y.g * p.g, g.b * y.b * p.b, w), this.alpha = x.a;
                var E = [],
                    M = [],
                    T = [],
                    A = [],
                    ...
                    I = c,
                    C = u;
                for (l.isClipping() && (console.log("isClipping == ", i.name), b = l.clippedVertices.length, R = l.clippedTriangles.length, I = l.clippedTriangles, C = l.clippedVertices); b > S;) E.push(C[S++]), E.push(C[S++]), T.push(u[S++]), T.push(u[S++]), T.push(u[S++]), T.push(u[S++]), M.push(u[S++]), M.push(u[S++]);
                for (S = 0; R > S; S++) A.push(I[S]);
                s ? (this.visible = !0, this.drawMesh(o, M, E, A, x), this.currentMesh.visible = !0) : this.visible = !1
            }
            l.clipEndWithSlot(e)
        }, n.prototype.drawMesh = function(t, e, n, r, a) {
            var i = this.currentMesh,
                o = i.$renderNode;
            o.uvs.length = e.length, o.vertices.length = n.length, o.indices.length = r.length, o.uvs = e;
            for (var s = 0; s < n.length; ++s) o.vertices[s] = n[s];
            o.indices = r, o.image = t.bitmapData, o.drawMesh(t.$bitmapX, t.$bitmapY, t.$bitmapWidth, t.$bitmapHeight, t.$offsetX, t.$offsetY, t.textureWidth, t.textureHeight), o.imageWidth = t.$sourceWidth, o.imageHeight = t.$sourceHeight, i.texture = t;
            var l = [a.r, 0, 0, 0, 0, 0, a.g, 0, 0, 0, 0, 0, a.b, 0, 0, 0, 0, 0, a.a, 0],
                h = new egret.ColorMatrixFilter(l);
            i.filters && i.filters.length > 0 ? i.filters[0] != h && (i.filters = [h]) : i.filters = [h], i.$updateVertices()
        }, n.prototype.colorHex = function(t) {
            for (var e = "0x", n = [t.r, t.g, t.b], r = 0; r < n.length; r++) {
                var a = Number(Math.floor(255 * n[r])).toString(16);
                a.length < 2 && (a = "0" + a), e += a
            }
            return 8 !== e.length && (e = "0xFFFFFF"), Number(e)
        }, n.prototype.createMesh = function(t) {
            var e = new egret.Mesh;
            return e.name = t.name, this.addChild(e), e
        }, n.prototype.computeRegionVertices = function(e, n, r) {
            var i = e.bone.skeleton,
                o = i.color,
                s = e.color,
                l = n.color,
                h = o.a * s.a * l.a,
                u = r ? h : 1,
                c = this.tempColor;
            c.set(o.r * s.r * l.r * u, o.g * s.g * l.g * u, o.b * s.b * l.b * u, h), n.computeWorldVertices(e.bone, a.vertices, 0, a.VERTEX_SIZE);
            var p = a.vertices,
                d = n.uvs;
            return p[t.RegionAttachment.C1R] = c.r, p[t.RegionAttachment.C1G] = c.g, p[t.RegionAttachment.C1B] = c.b, p[t.RegionAttachment.C1A] = c.a, p[t.RegionAttachment.U1] = d[0], p[t.RegionAttachment.V1] = d[1], p[t.RegionAttachment.C2R] = c.r, p[t.RegionAttachment.C2G] = c.g, p[t.RegionAttachment.C2B] = c.b, p[t.RegionAttachment.C2A] = c.a, p[t.RegionAttachment.U2] = d[2], p[t.RegionAttachment.V2] = d[3], p[t.RegionAttachment.C3R] = c.r, p[t.RegionAttachment.C3G] = c.g, p[t.RegionAttachment.C3B] = c.b, p[t.RegionAttachment.C3A] = c.a, p[t.RegionAttachment.U3] = d[4], p[t.RegionAttachment.V3] = d[5], p[t.RegionAttachment.C4R] = c.r, p[t.RegionAttachment.C4G] = c.g, p[t.RegionAttachment.C4B] = c.b, p[t.RegionAttachment.C4A] = c.a, p[t.RegionAttachment.U4] = d[6], p[t.RegionAttachment.V4] = d[7], p
        }, n.prototype.computeMeshVertices = function(e, n, r) {
            var i = e.bone.skeleton,
                o = i.color,
                s = e.color,
                l = n.color,
                ...
                u = r ? h : 1,
                c = this.tempColor;
            c.set(o.r * s.r * l.r * u, o.g * s.g * l.g * u, o.b * s.b * l.b * u, h);
            var p = n.worldVerticesLength / 2;
            a.vertices.length < n.worldVerticesLength && (a.vertices = t.Utils.newFloatArray(n.worldVerticesLength));
            var d = a.vertices;
            n.computeWorldVertices(e, 0, n.worldVerticesLength, d, 0, a.VERTEX_SIZE);
            for (var f = n.uvs, m = 0, v = p, g = 0, y = 2; v > m; m++) d[y++] = c.r, d[y++] = c.g, d[y++] = c.b, d[y++] = c.a, d[y++] = f[g++], d[y++] = f[g++], y += 2;
            return d
        }, n.prototype.createSprite = function(t, e) {
            var n = e.texture.spriteSheet,
                r = n.getTexture(e.name) || e.rotate ? n.createTexture(e.name, e.x, e.y, e.height, e.width, e.offsetX, e.offsetY, e.originalHeight, e.originalWidth) : n.createTexture(e.name, e.x, e.y, e.width, e.height, e.offsetX, e.offsetY, e.originalWidth, e.originalHeight),
                a = new egret.Bitmap(r);
            return a.name = e.name, a.x = t.x, a.y = t.y, a.anchorOffsetX = .5 * a.width, a.anchorOffsetY = .5 * a.height, a.scaleX = t.scaleX * (t.width / e.width), a.scaleY = -t.scaleY * (t.height / e.height), a.rotation = t.rotation, e.rotate && (a.rotation -= 90), this.addChild(a), a
        }, n
    }(egret.DisplayObjectContainer);
    t.SlotRenderer = i, __reflect(i.prototype, "spine.SlotRenderer")
}(spine || (spine = {}));
var spine;
! function(t) {
    var e = function() {
